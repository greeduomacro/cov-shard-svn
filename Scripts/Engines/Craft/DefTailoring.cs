    ...
    public class DefTailoring : CraftSystem
    {
       ...
       /* public override bool RetainsColorFrom(CraftItem item, Type type)
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SA)
            {
                //index = AddCraft(typeof(FemaleGargishClothChest), 1015269, "female gargish cloth chest", 80.0, 105.0, typeof(Cloth), 1044286, 10, 1044287);
                //SetNeededExpansion(index, Expansion.SA);

                //index = AddCraft(typeof(MaleGargishClothChest), 1015269, "male gargish cloth chest", 80.0, 105.0, typeof(Cloth), 1044286, 10, 1044287);
                //SetNeededExpansion(index, Expansion.SA);//////

                index = AddCraft(typeof(FemaleGargishClothChest), 1015269, "female gargish cloth chest", 50.0, 65.0, typeof(Cloth), 1044286, 10, 1044287);
                SetNeededExpansion(index, Expansion.SA);
               
                index = AddCraft(typeof(MaleGargishClothChest), 1015269, "male gargish cloth chest", 50.0, 65.0, typeof(Cloth), 1044286, 10, 1044287);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(FemaleGargishClothArms), 1015269, "female gargish cloth arms", 50.0, 65.0, typeof(Cloth), 1044286, 10, 1044287);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(MaleGargishClothArms), 1015269, "male gargish cloth arms", 50.0, 65.0, typeof(Cloth), 1044286, 10, 1044287);
                SetNeededExpansion(index, Expansion.SA);
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(FemaleGargishClothKilt), 1015279, "female gargish cloth kilt", 80.0, 105.0, typeof(Cloth), 1044286, 30, 1044287);
                SetNeededExpansion(index, Expansion.SA);
              
                index = AddCraft(typeof(MaleGargishClothKilt), 1015279, "male gargish cloth kilt", 80.0, 105.0, typeof(Cloth), 1044286, 30, 1044287);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(FemaleGargishClothLegs), 1015279, "female gargish cloth legs", 80.0, 105.0, typeof(Cloth), 1044286, 30, 1044287);
                SetNeededExpansion(index, Expansion.SA);

                index = AddCraft(typeof(MaleGargishClothLegs), 1015279, "male gargish cloth legs", 80.0, 105.0, typeof(Cloth), 1044286, 30, 1044287);
                SetNeededExpansion(index, Expansion.SA);
                ...
                if (Core.SA)
                {
                     index = AddCraft(typeof(GargishFancyRobe), 1015283, 1112740, 54.0, 65.0, typeof(Cloth), 1044286, 16, 1044287);
                    SetNeededExpansion(index, Expansion.SA);

                     index = AddCraft(typeof(GargishRobe), 1015283 , 1112739, 54.0, 65.0, typeof(Cloth), 1044286, 16, 1044287);
                    SetNeededExpansion(index, Expansion.SA);

                    index = AddCraft(typeof(GargoyleHalfApron), 1015283, 1099568, 20.0, 45.0, typeof(Cloth), 1044286, 6, 1044287);
                    SetNeededExpansion(index, Expansion.SA);

                    index = AddCraft(typeof(GargishClothWingArmor), 1015283, 1096700, 20.0, 45.0, typeof(Cloth), 1044286, 6, 1044287);
                    SetNeededExpansion(index, Expansion.SA);            
                ...
                if (Core.ML)
                {
                    ...
                    // TODO leather container engraving tool
                }
                #endregion
                ...
                AddCraft(typeof(PlateTalons), 1015288, 1095990, 70.0, 100.0, typeof(Leather), 1044462, 15, 1044463);
                SetNeededExpansion(index, Expansion.SA);
                #endregion
                ...
                if (Core.SA)
                {
                    AddCraft(typeof(MaleGargishLeatherArms), 1015293, "male gargish leather arms", 58.0, 83.0, typeof(Leather), 1044462, 6, 1044463);
                    AddCraft(typeof(MaleGargishLeatherChest), 1015293, "male gargish leather chest", 87.1, 112.1, typeof(Leather), 1044462, 10, 1044463);
                    AddCraft(typeof(MaleGargishLeatherKilt), 1015293, "male gargish leather kilt", 62.2, 87.2, typeof(Leather), 1044462, 6, 1044463);
                    AddCraft(typeof(MaleGargishLeatherLegs), 1015293, "male gargish leather legs", 87.2, 112.1, typeof(Leather), 1044462, 8, 1044463);
                    AddCraft(typeof(GargishLeatherWingArmor), 1015293, 1096663, 87.1, 112.1, typeof(Leather), 1044462, 10, 1044463);
                ...
                if (Core.SA)
                {
                    ...
                    AddCraft(typeof(FemaleGargishLeatherArms), 1015306, "female gargish leather arms", 58.0, 83.0, typeof(Leather), 1044462, 8, 1044463);
                    AddCraft(typeof(FemaleGargishLeatherChest), 1015306, "female gargish leather chest", 87.2, 112.1, typeof(Leather), 1044462, 8, 1044463);          
                    AddCraft(typeof(FemaleGargishLeatherKilt), 1015306, "female gargish leather kilt", 62.2, 87.2, typeof(Leather), 1044462, 8, 1044463);
                    AddCraft(typeof(FemaleGargishLeatherLegs), 1015306, "female gargish leather legs", 87.2, 112.1, typeof(Leather), 1044462, 8, 1044463);
