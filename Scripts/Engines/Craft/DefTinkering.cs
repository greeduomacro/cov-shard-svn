...
namespace Server.Engines.Craft
{
	...
	public class DefTinkering : CraftSystem
	{
		...
		private static Type[] m_TinkerColorables = new Type[]
			{
				...
				typeof( Plate ), typeof( Clippers ),
				typeof( Goblet ), typeof( PewterMug ),
				typeof( KeyRing ), typeof( Container ),
                typeof( BaseContainer ), typeof( FillableContainer ),
				typeof( Candelabra ), typeof( Scales ),
				typeof( Key ), typeof( Globe ),
				typeof( Spyglass ), typeof( Lantern ),
				typeof( HeatingStand ), typeof( RoundBasket ),typeof( Basket ),
                typeof( Item ), typeof( DryReeds ), typeof( SoftenedReeds ),
		...
		public void AddJewelrySet( GemType gemType, Type itemType )
		{
            ...
            index = AddCraft(typeof(GargishRing), 1044049, 1095786, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, itemType, 1044231 + offset, 1, 1044240);/////////////////////////////
            ...
            index = AddCraft(typeof(GargishNecklace), 1044049, 1095784, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, itemType, 1044231 + offset, 1, 1044240);/////////////////////////////

			index = AddCraft( typeof( GoldEarrings ), 1044049, 1044203 + offset, 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			AddRes( index, itemType, 1044231 + offset, 1, 1044240 );

            index = AddCraft(typeof(GargishEarrings), 1044049, 1095787, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, itemType, 1044231 + offset, 1, 1044240);/////////////////////////////
            ...
            index = AddCraft(typeof(GargishBracelet), 1044049, 1095785, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
            AddRes(index, itemType, 1044231 + offset, 1, 1044240);////////////////////////////
		}
		...
		public override void InitCraftList()
		{
            ...
            AddCraft( typeof(CarpetShuttle), 1044042, "Carpet Shuttle(needs Carpet Loom)", 75.0, 110.0, typeof(Log), 1044041, 4, 1044351);

           // index = AddCraft(typeof(SoftenedReeds), 1044042, 1112249, 75.0, 100.0, typeof(DryReeds), 1112248, 2, "You need more dry reeds to make this.");
           // AddRes(index, typeof(ScouringToxin), 1112292, 1, "You need more scouring toxin to make this."); 
            ...
            AddCraft( typeof( Clippers ), 1044046, 1112117, 70.0, 75.0, typeof( IronIngot ), 1044036, 2, 1044037 );
            AddCraft(typeof(BasketweavingPliers), 1044046, 1112245, 75.0, 93.4, typeof(IronIngot), 1044036, 2, 1044037);
            AddSkill(index, SkillName.Carpentry, 40.0, 45.0);
			...
			AddCraft( typeof( FoodPlate ), 1044048, 1022519, 0.0, 50.0, typeof( IronIngot ), 1044036, 2, 1044037 );
            ...
            if (Core.SA)
            {
                index = AddCraft(typeof(GargoyleCandelabra), 1044050, 1095313, 55.0, 105.0, typeof(IronIngot), 1044036, 6, 1044037);
            }
			...
			AddSubRes( typeof( SilverIngot ),       	"Silver", 100.0, 1044268 );
			...
			AddSubRes( typeof( JadeIngot ),         	"Jade", 105, 1044268 );
			AddSubRes( typeof( MoonstoneIngot ),    	"Moonstone", 110, 1044268 );
			AddSubRes( typeof( SunstoneIngot ),     	"Sunstone", 115, 1044268 );
			//AddSubRes( typeof( BloodstoneIngot ),   	"BLOODSTONE", 90.0, 1044268 );

            //SetSubRes2( typeof( SoftenedReeds ), 1112249 );
