...
namespace Server.Engines.Craft
{
    public class AlterItem
    {
        ...
        public static bool TryToAlter(Mobile from, Item olditem)
        {
            ...
            else if (olditem is BaseShield && newitem is BaseShield)
            {
                ...
                //newshield.ArmorAttributes = new AosArmorAttributes(oldshield, newshield.ArmorAttributes);
    ...
    public class AlterItemTarget : Target
    {
        ...
        private BaseTool m_Tool;/// mod
        //private CraftResource m_Resource;

        public AlterItemTarget(CraftSystem system, BaseTool tool) : base(1, false, TargetFlags.None)
        {
            m_System = system;
            m_Tool = tool;// mod
            //m_Resource = resource;
