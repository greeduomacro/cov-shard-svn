...
namespace Server.Items
{
	...
	public abstract class BaseGlovesOfLumberjacking : BaseArmor
	{
		...
		public BaseGlovesOfLumberjacking( int bonus, int itemID ) : base( itemID )
		{
			...
			this.Hue = CraftResources.GetHue( (CraftResource)Utility.RandomMinMax( (int)CraftResource.Pine, (int)CraftResource.Yew ) );
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Bonus != 0 )
				list.Add( "lumberjacking bonus +~1_yew~", m_Bonus.ToString() ); // mining bonus +~1_yew~
		}
