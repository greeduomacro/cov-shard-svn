// Script Name: Modified Fishing.cs for WoodCrafting 2.0
	...
	public class Fishing : HarvestSystem
	{
		...
		private Fishing()
		{
			...
			res = new HarvestResource[]
				{
					new HarvestResource( 00.0, 00.0, 100.0, "Halibut",		typeof( Halibut ), 		typeof( BigHalibut ) ),
					new HarvestResource( 15.0, -10.0, 100.0, "Salmon",		typeof( Salmon ),		typeof( BigSalmon ) ),
					new HarvestResource( 30.0, 5.0, 100.0, "Trout", 		typeof( Trout ),		typeof( BigTrout ) ),
					new HarvestResource( 45.0, 20.0, 100.0, "Fluke", 		typeof( Fluke ),		typeof( BigFluke ) ),
					new HarvestResource( 60.0, 35.0, 100.0, "Parrot Fish",	typeof( ParrotFish ),		typeof( BigParrotFish ) ),
					new HarvestResource( 75.0, 50.0, 100.0, "Red Snapper", 	typeof( RedSnapper ),	typeof( BigRedSnapper ) ),
					new HarvestResource( 90.0, 65.0, 100.0, "Mahi", 		typeof( Mahi ),		typeof( BigMahi ) )
				};

			veins = new HarvestVein[]
				{
					new HarvestVein( 15.0, 0.0, res[0], null   ),  //Halibut
					new HarvestVein( 15.0, 0.0, res[1], res[0] ),//Salmon
					new HarvestVein( 15.0, 0.0, res[2], res[0] ),//Trout
					new HarvestVein( 15.0, 0.0, res[3], res[0] ),//Fluke
					new HarvestVein( 15.0, 0.0, res[4], res[0] ),//ParrotFish
					new HarvestVein( 15.0, 0.0, res[5], res[0] ),//RedSnapper
					new HarvestVein( 10.0, 0.0, res[6], res[0] ),//Mahi
				};
			...
			fish.BonusResources = new BonusHarvestResource[]
				{
					...
					new BonusHarvestResource( 80, .6, 1072597, typeof( WhitePearl ) )
				};
			#endregion
...
// driftwood label
				...
				else if ( item is RedSnapper )
				{
					number = 1008124;
					name = "A Red Snapper";
				}
				else if ( item is BigRedSnapper )
				{
					number = 1008124;
					name = "A Large Red Snapper";
				}
				else if ( item is ParrotFish )
				{
					number = 1008124;
					name = "A Parrot Fish";
				}
				else if ( item is BigParrotFish )
				{
					number = 1008124;
					name = "A Large Parrot Fish";
				}
				else if ( item is Fluke )
				{
					number = 1008124;
					name = "A Fluke";
				}
				else if ( item is BigFluke )
				{
					number = 1008124;
					name = "A Large Fluke";
				}
				else if ( item is Mahi )
				{
					number = 1008124;
					name = "A Mahi";
				}
				else if ( item is BigMahi )
				{
					number = 1008124;
					name = "A Big Mahi";
				}
				else if ( item is Halibut )
				{
					number = 1008124;
					name = "A Halibut";
				}
				else if ( item is BigHalibut )
				{
					number = 1008124;
					name = "A Large Halibut";
				}
				else if ( item is Trout )
				{
					number = 1008124;
					name = "A Trout";
				}
				else if ( item is BigTrout )
				{
					number = 1008124;
					name = "A Large Trout";
				}
				else if ( item is Salmon )
				{
					number = 1008124;
					name = "A Salmon";
				}
				else if ( item is BigSalmon )
				{
					number = 1008124;
					name = "A Large Salmon";
				}
