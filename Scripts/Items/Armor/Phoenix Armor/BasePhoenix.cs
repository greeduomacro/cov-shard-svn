...
{
	public abstract class BasePhoenix : BaseMeleeWeapon
	{
		...
		public override int DefMissSound{ get{ return 0x5C; } }
		...
		public BasePhoenix( int itemID ) : base( itemID )
		{
		}

		public BasePhoenix( Serial serial ) : base( serial )
		{
		}
