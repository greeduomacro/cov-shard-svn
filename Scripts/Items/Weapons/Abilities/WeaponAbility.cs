...
namespace Server.Items
{
	public abstract class WeaponAbility
	{
		...
		private static WeaponAbility[] m_Abilities = new WeaponAbility[34]
			{
				null,
				new ArmorIgnore(),
				new BleedAttack(),
        ...
        public static readonly WeaponAbility RecluseStrike		= m_Abilities[30];
	    public static readonly WeaponAbility Disrobe            = m_Abilities[31];   
		public static readonly WeaponAbility InfusedThrow		= m_Abilities[32];
		public static readonly WeaponAbility MysticArc			= m_Abilities[33];
