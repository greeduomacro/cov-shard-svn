...
namespace Server.Items
{
	public class Bladeweave : WeaponAbility
	{
		...
		public override bool OnBeforeDamage( Mobile attacker, Mobile defender )
		{
			...
			attacker.SendMessage( "You become one with your weapon, allowing it to guide your hand. The effects of this attack are unpredictable, but effective." );
			defender.SendMessage( "Your enemy becomes one with their weapon and the effects of the attack are unpredictable" );
