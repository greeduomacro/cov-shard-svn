...
namespace Server.Items
{
    ...
    public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability, ISetItem
    {
        ...
        private bool m_Enchanted; // Is this weapon enchanted via Enchant spell? Temporary; not serialized
        #endregion
        ...
        public override void OnAfterDuped(Item newItem)
        {
            ...
            //weap.m_Enchanted = new Enchanted( newItem, m_Enchanted );
			#endregion
        }
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            switch (m_Resource)
            {
                ...
                #region Mondain's Legacy
                case CraftResource.Oak: oreType = 1072533; break; // oak
                case CraftResource.Ash: oreType = 1072534; break; // ash
                case CraftResource.Yew: oreType = 1072535; break; // yew
