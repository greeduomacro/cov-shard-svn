	...
	public class PotionKeg : Item
	{
		...
		public override void AddNameProperty(ObjectPropertyList list)
		{
			if ( m_Held > 0 )
			{
                ...
                {
                    list.Add("a keg of GreaterConflagration potions");
                }
                else if (m_Type == PotionEffect.ConfusionBlast)
                {
                    list.Add("a keg of ConfusionBlast potions");
                }
                else if (m_Type == PotionEffect.ConfusionBlastGreater)
                {
                    list.Add("a keg of GreaterConfusionBlast potions");
                }
               ...
               /* }
                else if (m_Type == PotionEffect.HoveringWisp)
                {
                    list.Add("a keg of HoveringWisp potions");*/
                }
                else
                {
		...
		public BasePotion FillBottle()
		{
			switch ( m_Type )
			{
                ...
                //case PotionEffect.HoveringWisp:            return new HoveringWispPotion();
