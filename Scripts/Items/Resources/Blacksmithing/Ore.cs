...
namespace Server.Items
{
    public abstract class BaseOre : Item, ICommodity
    {
        ...
        public override int LabelNumber
        {
            get
            {
                if (m_Resource >= CraftResource.DullCopper && m_Resource <= CraftResource.Sunstone)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (IsForge(targeted))
                {
                    ...
                    switch (m_Ore.Resource)
                    {
                        ...
                        case CraftResource.Silver: difficulty = 100.0; break;
                        ...
                        case CraftResource.Jade: difficulty = 105.0; break;
                        case CraftResource.Moonstone: difficulty = 110.0; break;
                        case CraftResource.Sunstone: difficulty = 115.0; break;
    ...
    public class JadeOre : BaseOre
    {
        ...
        [Constructable]
        public JadeOre(int amount)
            : base(CraftResource.Jade, amount)
        {
        }

        public JadeOre(Serial serial)
            : base(serial)
        {
        }
    ...
    public class SunstoneOre : BaseOre
    {
        ...
        [Constructable]
        public SunstoneOre(int amount)
            : base(CraftResource.Sunstone, amount)
        {
        }

        public SunstoneOre(Serial serial)
            : base(serial)
        {
        }
