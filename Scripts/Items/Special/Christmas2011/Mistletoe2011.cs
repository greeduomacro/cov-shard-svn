...
{
	public class MistletoeAddon2011 : Item, IDyable, IAddon
	{
		[Constructable]
		public MistletoeAddon2011() : this( Utility.RandomDyedHue() )
		{
		}

		[Constructable]
		public MistletoeAddon2011( int hue ) : base( 0x2375 )
		{
			Hue = hue;
			Movable = false;
		}

		public MistletoeAddon2011( Serial serial ) : base( serial )
		{
		}
		...
		public Item Deed
		{
			get{ return new MistletoeDeed2011( this.Hue ); }
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( house != null && house.IsCoOwner( from ) )
			{
				...
				{
					from.CloseGump( typeof( MistletoeAddonGump2011 ) );
					from.SendGump( new MistletoeAddonGump2011( from, this ) );
				}
				else
				{
		...
		private class MistletoeAddonGump2011 : Gump
		{
			private Mobile m_From;
			private MistletoeAddon2011 m_Addon;

			public MistletoeAddonGump2011( Mobile from, MistletoeAddon2011 addon ) : base( 150, 50 )
			{
				m_From = from;
				m_Addon = addon;
	...
	public class MistletoeDeed2011: Item
	{
		public override int LabelNumber{ get{ return 1070882; } } // Mistletoe Deed

		[Constructable]
		public MistletoeDeed2011() : this( 0 )
		{
		}

		[Constructable]
		public MistletoeDeed2011( int hue ) : base( 0x14F0 )
		{
			Hue = hue;
			Weight = 1.0;
		...
		public MistletoeDeed2011( Serial serial ) : base( serial )
		{
		}
		...
		public void Placement_OnTarget( Mobile from, object targeted, object state )
		{
			...
			if ( house != null && house.IsCoOwner( from ) )
			{
				...
				if ( northWall && westWall )
					from.SendGump( new MistletoeDeedGump2011( from, loc, this ) );
				else
		...
		private void PlaceAddon( Mobile from, Point3D loc, bool northWall, bool westWall )
		{
			...
			if ( itemID > 0 )
			{
				Item addon = new MistletoeAddon2011( this.Hue );
		...
		private class MistletoeDeedGump2011 : Gump
		{
			private Mobile m_From;
			private Point3D m_Loc;
			private MistletoeDeed2011 m_Deed;

			public MistletoeDeedGump2011( Mobile from, Point3D loc, MistletoeDeed2011 deed ) : base( 150, 50 )
			{
				m_From = from;
				m_Loc = loc;
				m_Deed = deed;
