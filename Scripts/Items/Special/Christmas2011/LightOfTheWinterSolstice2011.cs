...
namespace Server.Items
{
	...
	public class LightOfTheWinterSolstice2011  : Item
	{
		...
		[Constructable]
		public LightOfTheWinterSolstice2011() : this( m_StaffNames[Utility.Random( m_StaffNames.Length )] )
		{
		}

		[Constructable]
		public LightOfTheWinterSolstice2011( string dipper ) : base( 0x236E )
		{
			m_Dipper = dipper;
		...
		public LightOfTheWinterSolstice2011( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnSingleClick( Mobile from )
		{
			...
			LabelTo( from, "Christmas 2011" ); // Winter 2009
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( "Christmas 2011"  ); // Winter 2009
		}
