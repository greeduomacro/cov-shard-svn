...
namespace Server.Items
{
	...
	{
		[Constructable]
		public MistletoeAddon2008() : this( Utility.RandomDyedHue() )
		{
		}

		[Constructable]
		public MistletoeAddon2008( int hue ) : base( 0x2375 )
		{
			Hue = hue;
			Movable = false;
		}

		public MistletoeAddon2008( Serial serial ) : base( serial )
		{
		}
		...
		public Item Deed
		{
			get{ return new MistletoeDeed2008( this.Hue ); }
		}
		...
		private class MistletoeAddonGump2008 : Gump
		{
			...
			public MistletoeAddonGump2008( Mobile from, MistletoeAddon2008 addon ) : base( 150, 50 )
			{
				m_From = from;
				m_Addon = addon;
	...
	public class MistletoeDeed2008 : Item
	{
		...
		[Constructable]
		public MistletoeDeed2008() : this( 0 )
		{
		}

		[Constructable]
		public MistletoeDeed2008( int hue ) : base( 0x14F0 )
		{
			Hue = hue;
			Weight = 1.0;
		...
		public MistletoeDeed2008( Serial serial ) : base( serial )
		{
		}
		...
		private class MistletoeDeedGump2008 : Gump
		{
			...
			public MistletoeDeedGump2008( Mobile from, Point3D loc, MistletoeDeed2008 deed ) : base( 150, 50 )
			{
				m_From = from;
				m_Loc = loc;
				m_Deed = deed;
