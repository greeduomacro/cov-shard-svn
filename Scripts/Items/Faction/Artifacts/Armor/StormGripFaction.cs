...
{
	public class StormGripFaction : LeatherGloves
		{
			#region FactionOwner
		...
		public override int LabelNumber{ get{ return 1070970; } } // StormGripFaction
		...
		public override int BaseEnergyResistance { get { return 18; } }
			...
			public StormGripFaction( Serial serial ) : base( serial )
				{
				}
