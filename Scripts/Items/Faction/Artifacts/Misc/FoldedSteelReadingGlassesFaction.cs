...
{
	public class FoldedSteelReadingGlassesFaction : Glasses
	{
		...
		[Constructable]
		public FoldedSteelReadingGlassesFaction( Faction faction, Mobile mobile ) : base()
		{
			Hue = 1150;
			m_Owner = mobile;
			Name = "Folded Steel Reading Glasses";
			Weight = 1;
		...
		public FoldedSteelReadingGlassesFaction( Serial serial ) : base( serial )
		{
		}
