...
{
	public class ClaininsSpellbookFaction : Spellbook
		{
			#region FactionOwner
			...
			[Constructable]
			public ClaininsSpellbookFaction( Faction faction, Mobile mobile ) : base()
				{
					Hue = 0x8A5;
			...
			public ClaininsSpellbookFaction( Serial serial ) : base( serial )
				{
				}
