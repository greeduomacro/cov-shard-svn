...
{
	public class TomeOfLostKnowledgeFaction : Spellbook
		{
			#region FactionOwner
		...
		public override int LabelNumber { get { return 1070971; } } // Tome of Lost Knowledge
			...
			[Constructable]
			public TomeOfLostKnowledgeFaction( Faction faction, Mobile mobile ) : base()
				{
					Hue = 0x530;
			...
			public TomeOfLostKnowledgeFaction( Serial serial ) : base( serial )
				{
				}
