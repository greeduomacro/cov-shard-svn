...
{
    public class APrimeronArmsDamageRemovalFaction: LeatherArms
		{
			...
			public override int InitMaxHits{ get{ return 255; } }
              ...
              [Constructable]
              public APrimeronArmsDamageRemovalFaction( Faction faction, Mobile mobile ) : base()
				{

					Weight = 1;
					Name = "A Primer on Arms Damage Removal";
					Hue = 0;
              ...
              public APrimeronArmsDamageRemovalFaction( Serial serial ) : base( serial )
                      {
                      }
