...
namespace Server.Items
{
	...
	public class RingOfTheVileFaction : GoldRing
	{
		...
		[Constructable]
		public RingOfTheVileFaction( Faction faction, Mobile mobile ) : base()
		{
			Hue = 0x4F7;
		...
		public RingOfTheVileFaction( Serial serial ) : base( serial )
		{
		}
