...
{
    [CorpseName("AGhostlyBlacksmith's Corpse")]
    public class AGhostlyBlacksmith : Mobile
    {
        ...
        public class AGhostlyBlacksmithEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                {
                    Item am = mobile.Backpack.FindItemByType(typeof(BlacksmithMarker));
                    if (am != null)
                    {
                        mobile.SendMessage("You are not finished with this quest yet.");
                    }
                    else
                    {
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            Item ak = mobile.Backpack.FindItemByType(typeof(BlacksmithMarker));

            if (ak != null && mobile != null)
            {
