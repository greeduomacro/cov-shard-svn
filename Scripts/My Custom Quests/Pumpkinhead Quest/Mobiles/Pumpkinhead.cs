...
namespace Server.Mobiles
{
	public class Pumpkinhead : BaseCreature
	{
		...
		/* Rem3 Put this section back in last
		...
		public Pumpkinhead( Mobile summoner, Mobile target, TimeSpan duration ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.18, 0.36 )
		{
			Name = "Pumpkinhead";
			Body = 309;
			//Rem3 BaseSoundID = 0x280;
			Hue = 1023;
		...
		public Pumpkinhead( Serial serial ) : base( serial )
		{
		}
