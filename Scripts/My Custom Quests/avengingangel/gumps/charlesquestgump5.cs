...
{
	public class CharlesQuestGump5 : Gump
	{
		public CharlesQuestGump5( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "<i>We still have a lot to do! Keep going and find the Gargoyles!</i>", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump5 ) );
					from.AddToBackpack (new GargoyleContract ());
					break;
				}
