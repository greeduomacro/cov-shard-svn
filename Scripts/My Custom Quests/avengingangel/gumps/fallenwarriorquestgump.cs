...
{
	public class FallenWarriorQuestGump : Gump
	{
		public FallenWarriorQuestGump( Mobile m): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Fallen Warrior");
			this.AddButton(226, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddButton(351, 469, 241, 242,  1, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "You approach the cemetary and are stopped by the spirit of a fallen warrior.<br><br><i>Please here my tale. I am Robert the Bold. I was engaged to the fair and beautiful Penthesilea of Britain. To prove to her father, Charles, that I was worthy of her hand, I sought a name for myself. <br><br>  As I set out to seek my fortune and her fair hand, I was slain by scoundrels in my room.  If you take up my struggle and avenge my foul murder, you shall be awarded with armour empowered by my spirit. <br><br> Will you seek her father and finish my quest? Will you be instrument of justice and take revenge upon those who killed me? Will you be the avenging angel and give my spirit rest?</i>", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					from.SendMessage( "Seek Charles of Britain" );
					from.CloseGump( typeof( FallenWarriorQuestGump ) );
					from.AddToBackpack(new FallenWarriorMarker2());
					
					break;
				}
				case 1:
				{
					from.SendMessage( "My torment continues..." );
					from.CloseGump( typeof( FallenWarriorQuestGump ) );
					from.Backpack.ConsumeTotal( typeof( FallenWarriorMarker ), 1 );
					break;
				}
			}
		}
