...
{
	public class FallenWarriorQuestGump2 : Gump
	{
		public FallenWarriorQuestGump2( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddLabel(282, 151, 1153, @"Fallen Warrior Quest");
			this.AddButton(282, 469, 247, 248, 0, GumpButtonType.Reply, 0);
			this.AddHtml( 157, 181, 345, 279, "The warrior starts to weep. He can't believe that you have actually completed the task. <br><br>He looks weary.<br><br> He looks at you and says:<br><br><i>I can't begin to tell you how grateful I am to you, I am grateful to finally be able to rest and have peace. I thank you for this. I have taken all the broken armor you carried and have restored it.<br><br>Your quest isn't over yet. My loved one needs to be rescued. If you could please give this scroll to her father, it will wash away the spell that Khashina cast on her</i><br><br>You walk away quietly, leaving the warrior weeping.", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( FallenWarriorQuestGump2 ) );
					from.AddToBackpack( new RestorationScroll () );
					from.AddToBackpack( new FallenWarriorMarker3 () );
					break;
				}
