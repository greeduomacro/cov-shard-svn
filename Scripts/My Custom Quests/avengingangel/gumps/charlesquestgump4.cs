...
{
	public class CharlesQuestGump4 : Gump
	{
		public CharlesQuestGump4( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "<i>I can almost feel her warm embrace again! Continue please! Succubus are what you are looking for now!!", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump4 ) );
					from.AddToBackpack (new SuccubusContract ());
					break;
				}
