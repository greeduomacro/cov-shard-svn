...
{
	public class CharlesQuestGump8 : Gump
	{
		public CharlesQuestGump8( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "All of a sudden you see Penthesilea appear out of nowhere and Charles falls to his knees. Penthesilea runs to her father. <br><br>Charles turns to you and says:<i>I am eternaly grateful to you for returning my beloved daughter to the realm of the living and take this check as a token. I don't have much to offer but this is all I have and you must take it. I am overjoyed!</i><br><br> You see Charles and his daughter Penthesilea hug and crying and you decide it would be time to leave them alone as they have much catching up to do.", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump8 ) );
