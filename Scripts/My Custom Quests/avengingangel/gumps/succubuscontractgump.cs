...
{
	public class SuccubusContractGump : Gump
	{
		private SuccubusContract MCparent;
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( info.ButtonID == 2 )
			{
				...
				m_from.AddToBackpack( new SuccubusClue() );
				m_from.AddToBackpack( new CharlesMarker4());
			}
		}
