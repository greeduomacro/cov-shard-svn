...
namespace Server.Items
{
	...
	public class LichContract : Item
	{
		...
		[Constructable]
		public LichContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public LichContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new LichContractGump( from, this ) );
			} 
			else 
		    {
		...
		public LichContract( Serial serial ) : base( serial ) 
		{ 
		} 
