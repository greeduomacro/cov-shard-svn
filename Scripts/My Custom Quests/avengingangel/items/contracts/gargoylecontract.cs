...
namespace Server.Items
{
	...
	public class GargoyleContract : Item
	{
		...
		[Constructable]
		public GargoyleContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public GargoyleContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new GargoyleContractGump( from, this ) );
			} 
			else 
		    {
		...
		public GargoyleContract( Serial serial ) : base( serial ) 
		{ 
		} 
