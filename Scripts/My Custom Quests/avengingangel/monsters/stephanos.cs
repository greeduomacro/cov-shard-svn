...
{
	[CorpseName( "a corpse" )]
	public class Stephanos : BaseCreature
	{
		[Constructable]
		...
		public Stephanos( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDeath(Container c)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (a != null)
                {
                    ...
                    pm.AddToBackpack(new CrackedGorget());
            ...
            else if (m is BaseCreature)
            {
                ...
                if (bc.Controlled == true)
                {
                    ...
                    if (a != null)
                    {
						bc.ControlMaster.AddToBackpack(new CrackedGorget());
