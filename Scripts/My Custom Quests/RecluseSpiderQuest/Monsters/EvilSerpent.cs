...
{
	[CorpseName("an evil serpent corpse")]
	[TypeAlias( "Server.Mobiles.Silverserpant" )]
	public class EvilSerpent : BaseCreature
	{
		...
		[Constructable]
		public EvilSerpent() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 92;
			Name = "an Evil Serpent";
			BaseSoundID = 219;
            Hue = 1165;
		...
		public EvilSerpent(Serial serial) : base(serial)
		{
		}
