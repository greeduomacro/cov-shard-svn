...
{
	[CorpseName( "Evil Alexis's Corpse" )]
	public class EvilAlexis : BaseCreature
	{
		[Constructable]
		public EvilAlexis() : base( AIType.AI_Animal, FightMode.Closest, 10, 5, 0.175, 0.75 )
		{		
			Name = "Evil Alexis";
			//Title = "";
			Body = 205;
			...
			AddItem( pack );
                	...
                	if ( gschance <= 0.7 )
                	{                      
                       		Item EvilAlexisPickaxe = new EvilAlexisPickaxe();
                       		AddItem( EvilAlexisPickaxe );
                	}
		}
		...
		public override void OnDamage( int amount, Mobile from, bool willKill )
		{
			...
			{
				m_InHere = true;
				AOS.Damage( from, this, Utility.RandomMinMax( 15, 20 ), 100, 0, 0, 0, 0 );
		...
		public EvilAlexis( Serial serial ) : base( serial )
		{
		}
