...
namespace Server.Items
{
	...
	public class MagicalLockbox : MetalBox
	{
                                                                                          ...
                                                                                          
		{
            ...
            //DropItem( new PersonalBlessDeed() );
...
//Strange Gems End
			...
			DropItem( new Gold( 2000, 5000 ) );
                    ...
                    switch (Utility.Random(9))
                    {
                        case 0: DropItem(new PersonalBlessDeed()); break;
                        case 1: DropItem(new ItemBlessDeed()); break;
                        case 2: DropItem(new ClothingBlessDeed()); break;

                    }

                    /*switch (Utility.Random(6))
                    {
                        case 0: DropItem(new KealdiaGlobe()); break;
                        case 1: DropItem(new KrysanGlobe()); break;
                        case 2: DropItem(new MyxkionGlobe()); break;
                        case 3: DropItem(new RivatachGlobe()); break;
                        case 4: DropItem(new VaectorGlobe()); break;
                        case 5: DropItem(new ValvakkaGlobe()); break;
                    }*/
