...
namespace Server.Mobiles
{
	...
	public class CrystalineSpider1 : BaseCreature
	{
		[Constructable]
		public CrystalineSpider1() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Crystaline spider ";
			Body = 20;
            Hue = 1266;
			BaseSoundID = 0x388;
        ...
        public CrystalineSpider1(Serial serial)
            : base(serial)
		{
		}
