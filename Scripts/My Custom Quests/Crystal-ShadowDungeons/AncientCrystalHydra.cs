...
namespace Server.Mobiles
{
	...
	public class AncientCrystalHydra : BaseCreature
	{
		[Constructable]
		public AncientCrystalHydra() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AncientCrystalHydra( Serial serial ) : base( serial )
		{
		}
