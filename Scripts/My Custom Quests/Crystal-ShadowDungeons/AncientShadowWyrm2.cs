...
namespace Server.Mobiles
{
	...
	public class AncientShadowWyrm2 : BaseCreature
	{
		[Constructable]
		public AncientShadowWyrm2() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Ancient Shadow Wyrm";
			Body = 46;
            Hue = 1108;
			BaseSoundID = 362;
		...
		public AncientShadowWyrm2( Serial serial ) : base( serial )
		{
		}
