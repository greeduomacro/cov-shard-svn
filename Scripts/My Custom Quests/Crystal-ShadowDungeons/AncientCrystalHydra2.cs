...
namespace Server.Mobiles
{
	...
	public class AncientCrystalHydra2 : BaseCreature
	{
		[Constructable]
		public AncientCrystalHydra2() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AncientCrystalHydra2( Serial serial ) : base( serial )
		{
		}
