...
namespace Server.Mobiles
{
	...
	public class AncientShadowWyrm1 : BaseCreature
	{
		[Constructable]
		public AncientShadowWyrm1() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AncientShadowWyrm1( Serial serial ) : base( serial )
		{
		}
