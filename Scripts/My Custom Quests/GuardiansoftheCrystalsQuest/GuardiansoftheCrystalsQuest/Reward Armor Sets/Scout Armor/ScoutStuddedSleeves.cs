...
{
	public class ScoutStuddedSleeves : StuddedArms
	{
		public override int LabelNumber{ get{ return 1080475; } } 
		...
		[Constructable]
		public ScoutStuddedSleeves() : base()
		{
            SetHue = 1827;
		...
		public ScoutStuddedSleeves( Serial serial ) : base( serial )
		{
		}
