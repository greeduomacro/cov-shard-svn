...
{
	public class SorcerersSleeves : LeatherArms
	{
		public override int LabelNumber{ get{ return 1080467; } } 
		...
		public SorcerersSleeves( Serial serial ) : base( serial )
		{
		}
