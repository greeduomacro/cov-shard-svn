...
//--------------------------------------Window size bar--------------------------------------------
			...
			AddLabel( 140, 60, 0x34, "Thieving Chickens" );
			

			AddHtml( 107, 140, 300, 230, "<BODY>" +
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=GREEN>Farmer Pilock Provisuns looks at you vaugely. After he puts down his bills, he says If you are brave enough, I have a task for you<BR><BR>I take it you wish for me to continue. *Farmer Pilock clears his throat* I was walking through the fields one day, and My Chickens stole my new weapon, Chicken Feather.<BR>" +
"<BASEFONT COLOR=GREEN>Are you still interested?<BR><BR>What I would need you to do, is go back to the fields outside and kill the chickens, they more than likely have already destroyed my bow but, you can still help." +
