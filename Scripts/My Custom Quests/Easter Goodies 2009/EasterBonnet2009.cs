...
{
	public class EasterBonnet2009 : BaseHat
	{
		...
		[Constructable]
		public EasterBonnet2009() : this( 0 )
		{
		}

		[Constructable]
		public EasterBonnet2009( int hue ) : base( 0x1714, hue )
		{
			Weight = 1.0;
            Name = "Easter Bonnet 2009";
            Hue = Utility.RandomList( 0xFF, 0x1F, 0xBAD, 0xAFE, 0x4DE, 0xAF5 );
			LootType = LootType.Blessed;
		}

		public EasterBonnet2009( Serial serial ) : base( serial )
		{
		}
