...
{
	[CorpseName( "an Evil Stag corpse" )]	
	public class EvilStag : BaseCreature
	{
		private DateTime m_NextFire;
		[Constructable]
		public EvilStag() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Evil Stag";
			Body = 0xEA;
			Hue = 0x59C;
		...
		public EvilStag( Serial serial ) : base( serial )
		{
		}
