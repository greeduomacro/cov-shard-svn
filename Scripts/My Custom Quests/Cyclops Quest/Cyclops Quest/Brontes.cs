...
namespace Server.Mobiles
{
	...
	public class Brontes : BaseCreature
	{
		[Constructable]
		public Brontes() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Brontes";
			Body = 75;
			BaseSoundID = 604;
            ...
            PackItem(new ThunderDaggerP());
            PackItem(new ValoriteIngot(25));
		}
		...
		public Brontes( Serial serial ) : base( serial )
		{
		}
