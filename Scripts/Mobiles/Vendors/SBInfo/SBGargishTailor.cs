...
{
	public class SBGargishTailor: SBInfo
	{
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBGargishTailor() 
		{ 
		} 
		...
		{ 
			public InternalBuyInfo()
			{
                ...
                Add( new GenericBuyInfo( typeof( FemaleGargishClothChest ), 11, 20, 0x0405, 0));
                Add( new GenericBuyInfo( typeof( MaleGargishClothChest ), 11, 20, 0x0406, 0));
                ...
                Add( new GenericBuyInfo( typeof( FemaleGargishClothLegs ), 11, 20, 0x0409, 0));
                Add( new GenericBuyInfo( typeof( MaleGargishClothLegs ), 11, 20, 0x040A, 0)); 
				Add( new GenericBuyInfo( typeof( FancyDress ), 26, 20, 0x1EFF, 0 ) );
				Add( new GenericBuyInfo( typeof( PlainDress ), 13, 20, 0x1F01, 0 ) );
				Add( new GenericBuyInfo( typeof( Skirt ), 11, 20, 0x1516, 0 ) );

				Add( new GenericBuyInfo( typeof( Kilt ), 11, 20, 0x1537, Utility.RandomDyedHue() ) );
                Add( new GenericBuyInfo( typeof( FemaleGargishClothKilt ), 11, 20, 0x0407, 0));
                Add( new GenericBuyInfo( typeof( MaleGargishClothKilt ), 11, 20, 0x0408, 0));
                Add( new GenericBuyInfo( typeof( FemaleGargishClothArms ), 11, 20, 0x0403, 0));
                Add( new GenericBuyInfo( typeof( MaleGargishClothArms ), 11, 20, 0x0404, 0));
				Add( new GenericBuyInfo( typeof( HalfApron ), 10, 20, 0x153b, 0 ) );
                Add( new GenericBuyInfo( typeof( GargoyleHalfApron ), 10, 20, 0x50D8, 0 ) );
                ...
                Add(new GenericBuyInfo(typeof( TailoringBox ), 500, 20, 0xE80, 0x3 ) );
			}
		}
