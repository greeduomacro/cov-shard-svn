...
namespace Server.Mobiles
{
	...
	public enum PlayerFlag // First 16 bits are reserved for default-distro use, start custom flags at 0x00010000
	{
        ...
        #region SA Gemmining
        GemMining = 0x00200000,
        ToggleMiningGem = 0x00400000,
        BasketWeaving = 0x00800000,
        NewNeighborsQuest = 0x01000000,
        GhostlyPests = 0x02000000,
        CullingTheDeadQuest = 0x04000000,
        StartupCostQuest = 0x08000000,
        #endregion
	    #region Plant system
        ToggleClippings 		= 0x00100000,
        ToggleCutClippings 		= 0x00300000,
        ToggleCutReeds 			= 0x00500000, 
        #endregion
		
        #region SA Mechanical Life
        MechanicalLife          = 0x06000000,
        #endregion
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
        ...
        private int m_FortuneType1;
        private int m_FortunePower1;
        private int m_FortuneType2;
        private int m_FortunePower2;
        private ResistanceMod m_FortuneMod1;
        private ResistanceMod m_FortuneMod2;
        ...
        public void AnnounceFortune(int fortune)
        {
            ...
            {
                default:
                case 1: SendLocalizedMessage(1060886); break;
                case 2: SendLocalizedMessage(1060887); break;
                case 3: SendLocalizedMessage(1060888); break;
                case 4: SendLocalizedMessage(1060889); break;
                case 5: SendLocalizedMessage(1060890); break;
                case 6: SendLocalizedMessage(1060891); break;
                case 7: SendLocalizedMessage(1060892); break;
                case 8: SendLocalizedMessage(1060893); break;
                case 9: SendLocalizedMessage(1060894); break;
                case 10: SendLocalizedMessage(1060895); break;
                case 11: SendLocalizedMessage(1060901); break;
                case 12: SendLocalizedMessage(1060902); break;
                case 13: SendLocalizedMessage(1060903); break;
                case 14: SendLocalizedMessage(1060904); break;
                case 15: SendLocalizedMessage(1060905); break;
                case 16: SendLocalizedMessage(1060906); break;
                case 17: SendLocalizedMessage(1060907); break;
                case 18: SendLocalizedMessage(1060908); break;
                case 19: SendLocalizedMessage(1060909); break;
                case 20: SendLocalizedMessage(1060910); break;
            }
        }
        ...
        {
            RemoveResistanceMod(m_FortuneMod1);
            RemoveResistanceMod(m_FortuneMod2);
            m_FortuneMod1 = m_FortuneMod2 = null;
        ...
        public int GetFortuneLuckMod()
        {
            ...
            {
                int v = 0;
                if (m_FortuneType1 == 6 || m_FortuneType1 == 8)
                    v = m_FortunePower1;
                else if (m_FortuneType1 == 16 || m_FortuneType1 == 18)
                    v = -m_FortunePower1;

                if (m_FortuneType2 == 6 || m_FortuneType2 == 8)
                    v += m_FortunePower2;
                else if (m_FortuneType2 == 16 || m_FortuneType2 == 18)
                    v -= m_FortunePower2;
                return v;
            }
        ...
        public int GetFortuneManaRegenMod()
        {
            ...
            {
                int v = 0;
                if (m_FortuneType1 == 10)
                    v = m_FortunePower1;
                else if (m_FortuneType1 == 20)
                    v = -m_FortunePower1;

                if (m_FortuneType2 == 10)
                    v += m_FortunePower2;
                else if (m_FortuneType2 == 20)
                    v -= m_FortunePower2;
                return v;
            }
        ...
        public int GetFortuneEnhancePotionsMod()
        {
            if (m_FortuneType1 > 0)
            {
                ...
                if (m_FortuneType1 == 7)
                    v = m_FortunePower1;
                else if (m_FortuneType1 == 17)
                    v = -m_FortunePower1;

                if (m_FortuneType2 == 7)
                    v += m_FortunePower2;
                else if (m_FortuneType2 == 17)
                    v -= m_FortunePower2;
                return v;
            }
        ...
        public int GetFortuneDefendChanceMod()
        {
            if (m_FortuneType1 > 0)
            {
                ...
                if (m_FortuneType1 == 9)
                    v = m_FortunePower1;
                else if (m_FortuneType1 == 19)
                    v = -m_FortunePower1;

                if (m_FortuneType2 == 9)
                    v += m_FortunePower2;
                else if (m_FortuneType2 == 19)
                    v -= m_FortunePower2;
                return v;
            }
	...
	#region Getters & Setters
        ...
        #region QueensLevelSystem              // Queens Level System/////////////////////////////////////////////////////////////
        ...
        [CommandProperty(AccessLevel.GameMaster)]///////////////////////////////
        public bool NewNeighborsQuest
        {
            get { return GetFlag(PlayerFlag.NewNeighborsQuest); }
            set { SetFlag(PlayerFlag.NewNeighborsQuest, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool GhostlyPests
        {
            get { return GetFlag(PlayerFlag.GhostlyPests); }
            set { SetFlag(PlayerFlag.GhostlyPests, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool CullingTheDeadQuest
        {
            get { return GetFlag(PlayerFlag.CullingTheDeadQuest); }
            set { SetFlag(PlayerFlag.CullingTheDeadQuest, value); }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool StartupCostQuest
        {
            get { return GetFlag(PlayerFlag.StartupCostQuest); }
            set { SetFlag(PlayerFlag.StartupCostQuest, value); }
        }
		...
		public override bool CanSee( Mobile m )
		{
            ...
            if (m is IFreezable)
                ((IFreezable)m).OnRequestedAnimation(this);
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            //  list.Add(String.Concat("Experience Level: ", String.Format("<BASEFONT COLOR={0}>{1}", "#FF0000", m_Level), ", ", String.Format("<BASEFONT COLOR={0}>{1}", "#05FF05", (int)(100 * m_Exp / m_LevelExp)), "%")); InvalidateMyRunUO();
            //  list.Add(String.Concat("Experience Title: ", String.Format("<BASEFONT COLOR={0}>{1}", "#000FFF", m_ExpTitle))); InvalidateMyRunUO();
            #endregion // End of Neo's Level System
        }
