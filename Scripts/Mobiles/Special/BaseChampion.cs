...
namespace Server.Mobiles
{
	public abstract class BaseChampion : BaseCreature
	{
        ...
        #region Feluca Ruleset Transcendence Scroll Edit 1
        public void GiveFelTranscendenceScrolls()
        {
            List<Mobile> toGive = new List<Mobile>();
            List<DamageStore> rights = BaseCreature.GetLootingRights(this.DamageEntries, this.HitsMax);
            ...
            for (int i = 0; i < 6; ++i)
            {
                ...
                GiveFelTranscendenceScrollTo(m, st);
            }
        }
        ...
        public override bool OnBeforeDeath()
		{
			if ( !NoKillAwards )
			{
                ...
                #region Felucca Ruleset Transcendence Scroll Edit 2
                if (map == Map.Felucca)
                {
                    GiveFelTranscendenceScrolls();
                }
                #endregion
