...
namespace Server.Mobiles
{
	...
	public class MasterOfTheArts : BaseCreature //make it use the creature files/settings
	{
		...
		public void GiveCraftPowerScroll() //Generate power scroll routine and add to pack
		{
			...
			PsCount = ChampionSpawn ? 5 : 1; //set how many ps to give if it spawned using champ spawn or normal spawn
			for ( int i = 0; i < PsCount; ++i ) 
			{
				...
				{
					switch ( Utility.Random( 56 )) //select random number between 0-46
					{
						case 0: m.AddToBackpack( new RunicFletcherTools( CraftResource.Pine, 10 ) ); break; // pine runic fletcher tool with 10 charges
						case 1: m.AddToBackpack( new RunicFletcherTools( CraftResource.Ash, 10 ) ); break;
						case 2: m.AddToBackpack( new RunicFletcherTools( CraftResource.Mahogany, 10 ) ); break;
						case 3: m.AddToBackpack( new RunicFletcherTools( CraftResource.Yew, 10 ) ); break;
						case 4: m.AddToBackpack( new RunicFletcherTools( CraftResource.Oak, 10 ) ); break;
						case 5: m.AddToBackpack( new RunicFletcherTools( CraftResource.Cherry, 10 ) ); break;
                        case 6: m.AddToBackpack( new RunicFletcherTools( CraftResource.Cedar, 10)); break;
						case 7: m.AddToBackpack( new RunicHammer( CraftResource.DullCopper, 10 ) ); break; // Dull Copper runic hamemr with 10 charges
						case 8: m.AddToBackpack( new RunicHammer( CraftResource.ShadowIron, 10 ) ); break;
						case 9: m.AddToBackpack( new RunicHammer( CraftResource.Copper, 10 ) ); break;
						case 10: m.AddToBackpack( new RunicHammer( CraftResource.Bronze, 10 ) ); break;
						case 11: m.AddToBackpack( new RunicHammer( CraftResource.Gold, 10 ) ); break;
						case 12: m.AddToBackpack( new RunicHammer( CraftResource.Agapite, 10 ) ); break;
						case 13: m.AddToBackpack( new RunicHammer( CraftResource.Verite, 10 ) ); break;
						case 14: m.AddToBackpack( new RunicHammer( CraftResource.Valorite, 10 ) ); break;
						case 15: m.AddToBackpack( new RunicHammer( CraftResource.Silver, 10 ) ); break;
						//case 16: m.AddToBackpack( new RunicHammer( CraftResource.Platinum, 10 ) ); break;
						//case 17: m.AddToBackpack( new RunicHammer( CraftResource.Mythril, 10 ) ); break;
						//case 18: m.AddToBackpack( new RunicHammer( CraftResource.Obsidian, 10 ) ); break;
						//case 19: m.AddToBackpack( new RunicHammer( CraftResource.Jade, 10 ) ); break;
                        case 16: m.AddToBackpack( new RunicHammer( CraftResource.Moonstone, 10 )); break;
                        case 17: m.AddToBackpack( new RunicHammer( CraftResource.Sunstone, 10)); break;
                        //case 22: m.AddToBackpack( new RunicHammer( CraftResource.Bloodstone, 10)); break;
						case 18: m.AddToBackpack( new RunicSewingKit( CraftResource.SpinedLeather, 10 ) ); break; // Spined Leather runic sewing kit with 10 charges
						case 19: m.AddToBackpack( new RunicSewingKit( CraftResource.HornedLeather, 10 ) ); break;
						case 20: m.AddToBackpack( new RunicSewingKit( CraftResource.BarbedLeather, 10 ) ); break;
						case 21: m.AddToBackpack( new RunicSewingKit( CraftResource.DragonLeather, 10 ) ); break;
						case 22: m.AddToBackpack( new RunicSewingKit( CraftResource.DaemonLeather, 10 ) ); break;
						case 23: m.AddToBackpack( new GorgetofExpertTailoring() ); break;
						case 24: m.AddToBackpack( new TunicofExpertTailoring() ); break;
						case 25: m.AddToBackpack( new CapofExpertTailoring() ); break;
						case 26: m.AddToBackpack( new LegsofExpertTailoring() ); break;
						case 27: m.AddToBackpack( new ArmsofExpertTailoring() ); break;
						case 28: m.AddToBackpack( new GlovesofExpertTailoring() ); break; // Dull Copper runic hamemr with 10 charges
		...
		public override bool OnBeforeDeath( ) //what happens before it dies
		{
			...
			switch (Utility.Random(10)) //select random number between 0-29
			{
