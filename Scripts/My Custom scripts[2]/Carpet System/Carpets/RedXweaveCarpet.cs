...
namespace Server.Items
{
	...
	public class RedXweaveCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new RedXweaveCarpetDeed(); } }
		...
		[Constructable]
		public RedXweaveCarpetAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public RedXweaveCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class RedXweaveCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public RedXweaveCarpetDeed( )
		{
			Name =  "Red Xweave Carpet";
		}

		public RedXweaveCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			RedXweaveCarpetDeed m_Deed = state as RedXweaveCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new RedXweaveCarpetAddon( rect );
