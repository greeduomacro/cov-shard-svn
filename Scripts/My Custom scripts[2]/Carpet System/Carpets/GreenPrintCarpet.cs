...
namespace Server.Items
{
	...
	public class GreenPrintCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new GreenPrintCarpetDeed(); } }
		...
		[Constructable]
		public GreenPrintCarpetAddon( Rectangle2D rect )
		{
		...
		public GreenPrintCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class GreenPrintCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public GreenPrintCarpetDeed( )
		{
			Name =  "Green Print Carpet";
		}

		public GreenPrintCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			GreenPrintCarpetDeed m_Deed = state as GreenPrintCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new GreenPrintCarpetAddon( rect );
