...
namespace Server.Items
{
	...
	public class GoldPrintCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new GoldPrintCarpetDeed(); } }
		...
		public GoldPrintCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class GoldPrintCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public GoldPrintCarpetDeed( )
		{
			Name =  "Gold Print Carpet";
		}

		public GoldPrintCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			GoldPrintCarpetDeed m_Deed = state as GoldPrintCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new GoldPrintCarpetAddon( rect );
