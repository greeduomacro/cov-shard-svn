...
namespace Server.Items
{
	...
	public class GreenRugAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new GreenRugDeed(); } }
		...
		[Constructable]
		public GreenRugAddon( Rectangle2D rect )
		{
		...
		public GreenRugAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class GreenRugDeed : BaseAddonDeed
	{
		...
		public GreenRugDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			GreenRugDeed m_Deed = state as GreenRugDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new GreenRugAddon( rect );
