...
namespace Server.Items
{
	...
	public class BluePrintCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new BluePrintCarpetDeed(); } }
		...
		[Constructable]
		public BluePrintCarpetAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public BluePrintCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BluePrintCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public BluePrintCarpetDeed( )
		{
			Name =  "Blue Print Carpet";
		}

		public BluePrintCarpetDeed( Serial serial ) : base( serial )
		{
		}
