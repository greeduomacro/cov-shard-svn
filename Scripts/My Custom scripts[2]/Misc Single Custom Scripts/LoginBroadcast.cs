...
namespace mordero.Custom
{
    class Broadcast
    {
        ...
        private readonly static string m_LoginMessage = "{0} has logged into the Shard of Champions Of Virtue ";//logging in
        private readonly static string m_LogoutMessage = "{0} has logged out of the Shard";//logging out
