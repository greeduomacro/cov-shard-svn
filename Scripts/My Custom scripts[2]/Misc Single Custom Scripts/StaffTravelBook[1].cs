...
{ 
   ...
   { 
      [Constructable] 
      public TravelBook() : base( 0x2252 ) 
      { 
         Movable = true; 
         Light = LightType.Circle300;
         Hue = 322; 
         Weight = 3;  
         Name = "Staff Travel Book"; 
   ...
   { 
      ...
      public static readonly PMList Trammel = 
         new PMList( "Trammel", "Trammel", Map.Trammel, new PMEntry[] 
            { 
               ...
               new PMEntry( new Point3D( 3499,2572,14), "New Haven"),//NewHaven
			   new PMEntry( new Point3D( 1417,3821,0 ), "Jhelom" ), // Jhelom 
			   new PMEntry( new Point3D( 3728,2164,20 ), "Magincia" ), // Magincia 
			   new PMEntry( new Point3D( 2526,583,0 ), "Minoc" ), // Minoc 
			   new PMEntry( new Point3D( 4471,1177,0 ), "Moonglow" ), // Moonglow 
      ...
      public static readonly PMList TrammelDungeons = 
         new PMList( "Trammel Dungeons", "Trammel Dungeons", Map.Trammel, new PMEntry[] 
		{
			   ...
			   new PMEntry( new Point3D( 731,1448,0 ), "Solen Hive D" ), // Solen Hive D
			   new PMEntry( new Point3D( 5451,3143,-60 ), "Terathan Keep" ),  // Terathan Keep
               new PMEntry( new Point3D( 4198, 3263, 2 ), "Underworld Entrance" ), //Underworld Entrance
               new PMEntry( new Point3D( 2043,238,10 ), "Wrong" )  // Wrong
		} );
      ...
      public static readonly PMList IlshenarCityShrine = 
         ...
         new PMList( "Ilsh Dungeons", "Ilsh Dungeons", Map.Ilshenar, new PMEntry[] 
            { 
			   ...
			   new PMEntry( new Point3D( 2186,1264,0 ), "Twisted Weald" ), // Twisted Weald
            ...
            { 
               new PMEntry( new Point3D( 449,928,-84 ), "Humility Champ" ), // Humility Champ
			   new PMEntry( new Point3D( 1640,1117,-7 ), "Spirituality Champ" ),  // Spirituality Champ
               new PMEntry( new Point3D( 390,333,-50 ), "Valor Champ" ), // Valor Champ
            } );

      public static readonly PMList Malas = 
         new PMList( "Malas", "Malas", Map.Malas, new PMEntry[] 
            { 
               new PMEntry( new Point3D( 879,1426,-90 ), "Quest Gate Castle" ), // Quest gate castle
			   ...
			   new PMEntry( new Point3D( 120,1684,0 ), "Bedlam" ), //Bedlam
               new PMEntry( new Point3D( 2368,1267,-85 ), "Doom" ),  // Doom 
			   new PMEntry( new Point3D( 329,1973,2 ), "Labyrinth" ), //Labyrinth
			   ...
			   new PMEntry( new Point3D( 1540,436,-86 ), "Northern Mountains" ), // Northern Mountains
            } ); 
      ...
      public static readonly PMList Tokuno = 
         new PMList( "Tokuno", "Tokuno", Map.Maps[4], new PMEntry[] 
            { 
			   ...
			   new PMEntry( new Point3D( 278,1198,20 ), "Homare Defiance Point" ), // Homare Defiance Point
      ...
      public static readonly PMList T2AChamps =
       new PMList("T2AChamps", "T2AChamps", Map.Felucca, new PMEntry[] 
            { 
			   ...
			   new PMEntry( new Point3D( 5196,3632,2 ), "Orc Fort Champ" ), //Orc Fort Champ
      ...
      public static readonly PMList TerMur =
        new PMList("TerMur Locations", "TerMur Locations", Map.TerMur, new PMEntry[] 
		{
               new PMEntry( new Point3D( 845, 3519, -44 ), "Royal City" ), // Royal City
			   new PMEntry( new Point3D( 926, 3983, -41 ), "Holy City" ), // Holy City
			   new PMEntry( new Point3D( 508, 3865, -33 ), "Desert Terror Champ Spawn" ), // TerMur
			   new PMEntry( new Point3D( 1126, 1074, -115 ), "Abyss Entrance (Underworld" ), // Abyss Entrance
			   new PMEntry( new Point3D( 34, 217, -15 ), "Tomb Of Kings" ), // Tomb Of Kings
			   new PMEntry( new Point3D( 812, 927, -15 ), "Medusa's Lair" ), // Peerless Medusa
			   new PMEntry( new Point3D( 368, 152, 0 ), "Stygian Dragon Altar" ), // Peerless Stygian Dragon
			   new PMEntry( new Point3D( 746, 476, -17 ), "Slasher Of Veils" ), // Peerless Slasher Of Veils
			   //new PMEntry( new Point3D( 2492,3931,5 ), "Valor" ), // Valor
		});
       
      /*Here you can edit what facets to show on the TravelBooks...*/ 

      public static readonly PMList[] UORLists = new PMList[]{ Felucca, Trammel, TrammelDungeons, FeluccaDungeons, FeluccaChamps, TerMur }; 
      public static readonly PMList[] LBRLists = new PMList[]{ Felucca, Trammel, IlshenarCityShrine, IlshenarChamps, TrammelDungeons, FeluccaDungeons, FeluccaChamps, TokunoChamp, T2AChamps, TerMur }; 
      public static readonly PMList[] AOSLists = new PMList[]{ Felucca, FeluccaDungeons, FeluccaMisc, FeluccaChamps, FeluccaShrines, Trammel, TrammelDungeons, TrammelMisc, TrammelShrines, IlshenarCityShrine, IlshenarDungForts, IlshenarChamps, Malas, Tokuno, TokunoChamp, T2AChamps, TerMur  }; 
      public static readonly PMList[] RedLists = new PMList[]{ Felucca, FeluccaDungeons, FeluccaChamps }; 
   } 
