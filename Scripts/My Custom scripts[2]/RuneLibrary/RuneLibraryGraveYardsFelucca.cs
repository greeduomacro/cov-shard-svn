...
{
	public class RuneLibraryGraveYardsFelucca : Item
	{
      ...
      {
         CommandSystem.Register( "RuneLibraryGraveYardsFelucca", AccessLevel.Owner, new CommandEventHandler( RuneLibraryGraveYardsFelucca_OnCommand ) );
      }

		public static void RuneLibraryGraveYardsFelucca_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         	RuneLibraryGraveYardsFelucca rl = new RuneLibraryGraveYardsFelucca(m);
		}
		...
		[Constructable]
		public RuneLibraryGraveYardsFelucca (Mobile from)
		{
			...
			for( int i=0; i<size; i++ )
			{
				...
				{
					rb.Name = "GraveYards Felucca " + nameStart + " - " + (nameEnd-1);
					library.Add(rb);
					rb = new Runebook(0);
					nameStart = nameEnd;
				}
		...
		public RuneLibraryGraveYardsFelucca( Serial serial ) : base( serial )
		{
		}
