   	...
   	public class ShrinkItem : Item
   	{
		...
		public BaseCreature Pet
		{
			...
			{ 
                ...
                m_PetMysticism = m_Mob.Skills[SkillName.Mysticism].Base;
                ...
                m_CapMysticism = m_Mob.Skills[SkillName.Mysticism].Cap;
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public Double SkillMysticism
        {
            get { return m_PetMysticism; }
        }
			...
			else if ( from is PlayerMobile && m_MobTypeString != null && m_PetOwner != null )
			{
				...
				else
				{
					...
					else
					{
                        ...
                        if (m_PetMysticism >= 0)
                            pet.Skills[SkillName.Mysticism].Base = m_PetMysticism;
                        ...
                        pet.Skills[SkillName.Mysticism].Cap = m_CapMysticism;
		...
		public override void AddNameProperties( ObjectPropertyList list )
		{
			...
			if ( m_MobTypeString != null )
			{
				...
				list.Add( 1060661, "Magic Skills\tMagery {0}, Mysticism {1}, Eval Intel {2}, Magic Resist {3}, Meditation {4}", m_PetMagery, m_PetMysticism, m_PetEvalInt, m_PetResist, m_PetMed );
            ...
            writer.Write(m_PetMysticism);

            writer.Write(m_CapMysticism);
			...
			switch ( version )
			{
                case 15:  //Added Mysticism
                {
                    m_PetMysticism = reader.ReadDouble();
                    m_CapMysticism = reader.ReadDouble();
                }
                    goto case 14;
