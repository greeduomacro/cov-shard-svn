...
{
	public class SpecialPetMount : BaseMount, ISpecialPet
	{
		public SpecialPetMount( string name, int bodyID, int itemID, AIType aitype, FightMode fightmode, int spot, int meleerange, double passivespeed, double activespeed ) : base( name, bodyID, itemID, aitype, fightmode, spot, meleerange, passivespeed, activespeed )
		{
			m_AbilityOneValue = 0;
			m_AbilityTwoValue = 0;
		...
		public SpecialPetMount( Serial serial ) : base( serial )
		{
		}
