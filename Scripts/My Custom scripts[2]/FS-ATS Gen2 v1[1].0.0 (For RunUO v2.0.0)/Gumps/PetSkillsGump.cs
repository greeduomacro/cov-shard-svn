...
namespace Server.Gumps
{
	public class PetSkillsGump : Gump
	{
		...
		public PetSkillsGump( Mobile pet ) : base( 0, 0 )
		{
			...
			Resizable=false;
			AddPage(0);
			AddBackground(30, 25, 306, 336, 5120);
            ...
            AddLabel(43, 182, 1149, @"Mysticism");
			AddLabel(43, 199, 1149, @"Evaluating Inteligence");
			AddLabel(43, 216, 1149, @"Meditation");
			AddLabel(43, 233, 1149, @"Swordsmanship");
			AddLabel(43, 250, 1149, @"Mace Fighting");
			AddLabel(43, 267, 1149, @"Fencing");
			AddLabel(43, 284, 1149, @"Archery");
			AddLabel(43, 301, 1149, @"Parry");
			...
			if ( m_Pet != null )
			{
                ...
                AddLabel(237, 182, 1149, m_Pet.Skills[SkillName.Mysticism].Base.ToString() );
				AddLabel(237, 199, 1149, m_Pet.Skills[SkillName.EvalInt].Base.ToString() );
				AddLabel(237, 216, 1149, m_Pet.Skills[SkillName.Meditation].Base.ToString() );
				AddLabel(237, 233, 1149, m_Pet.Skills[SkillName.Swords].Base.ToString() );
				AddLabel(237, 250, 1149, m_Pet.Skills[SkillName.Macing].Base.ToString() );
				AddLabel(237, 267, 1149, m_Pet.Skills[SkillName.Fencing].Base.ToString() );
				AddLabel(237, 284, 1149, m_Pet.Skills[SkillName.Archery].Base.ToString() );
				AddLabel(237, 301, 1149, m_Pet.Skills[SkillName.Parry].Base.ToString() );
			}
			...
			if ( m_Pet != null )
			{
                ...
                if (m_Pet.Skills[SkillName.Mysticism].Lock == SkillLock.Up)
                {
                    AddButton(293, 184, 2435, 2436, 7, GumpButtonType.Reply, 0);
                }
                else if (m_Pet.Skills[SkillName.Mysticism].Lock == SkillLock.Down)
                {
				...
				{
					AddButton(293, 303, 2435, 2436, 14, GumpButtonType.Reply, 0);
				}
				else if ( m_Pet.Skills[SkillName.Parry].Lock == SkillLock.Down )
				{
					AddButton(293, 303, 2437, 2438, 14, GumpButtonType.Reply, 0);
				}
				else
				{
					AddButton(293, 303, 2092, 2092, 14, GumpButtonType.Reply, 0);
				}
			}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
            ...
            if (info.ButtonID == 7)
            {
                if (m_Pet.Skills[SkillName.Mysticism].Lock == SkillLock.Up)
                {
                    m_Pet.Skills[SkillName.Mysticism].SetLockNoRelay(SkillLock.Down);
                    m_Pet.Skills[SkillName.Mysticism].Update();
                }
                else if (m_Pet.Skills[SkillName.Mysticism].Lock == SkillLock.Down)
                {
                    m_Pet.Skills[SkillName.Mysticism].SetLockNoRelay(SkillLock.Locked);
                    m_Pet.Skills[SkillName.Mysticism].Update();
                }
                else if (m_Pet.Skills[SkillName.Mysticism].Lock == SkillLock.Locked)
                {
                    m_Pet.Skills[SkillName.Mysticism].SetLockNoRelay(SkillLock.Up);
                    m_Pet.Skills[SkillName.Mysticism].Update();
                }
