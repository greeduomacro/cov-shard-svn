...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public PineappleTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public PineappleTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		{ 
			...
			this.Consume(); 
			Item item = new PineappleTreeSapling(); 
			item.Location = m_pnt; 
			item.Map = m_map; 
			
		} 

		public PineappleTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class PineappleTreeSapling : BaseCrop 
	{ 
		...
		[Constructable] 
		public PineappleTreeSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
			Name = "Pineapple Tree sapling";
			
			init( this );
		} 

		public static void init( PineappleTreeSapling plant )
		{
		...
		public PineappleTreeSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class PineappleTree : BaseTree
	{
		...
		[Constructable] 
		public PineappleTree( Point3D pnt, Map map ) : base( 0xCA8 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Pineapple Tree";
...
*/
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( PineappleTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( PineappleTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public PineappleTree( Serial serial ) : base( serial )
		{
		}
