...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public BlueberryTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public BlueberryTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public BlueberryTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public BlueberrySapling() : base( Utility.RandomList ( 0xCC9, 0xCC9 ) ) 
		{ 
			Movable = false; 
		...
		public BlueberrySapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class BlueberryTree : BaseTree
	{
		...
		[Constructable] 
		public BlueberryTree( Point3D pnt, Map map ) : base( 0xC9E ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Hue = 0x2A4;
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( BlueberryTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( BlueberryTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public BlueberryTree( Serial serial ) : base( serial )
		{
		}
