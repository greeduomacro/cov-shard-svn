...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public LimeTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public LimeTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public LimeTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public LimeSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public LimeSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class LimeTree : BaseTree
	{
		...
		[Constructable] 
		public LimeTree( Point3D pnt, Map map ) : base( 0xDA6 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Lime Tree";
...
*/
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( LimeTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( LimeTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public LimeTree( Serial serial ) : base( serial )
		{
		}
