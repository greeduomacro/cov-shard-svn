...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public BananaTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public BananaTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		{ 
			...
			this.Consume(); 
			Item item = new BananaTreeSapling(); 
			item.Location = m_pnt; 
			item.Map = m_map; 
			
		} 

		public BananaTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class BananaTreeSapling : BaseCrop 
	{ 
		...
		[Constructable] 
		public BananaTreeSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
			Name = "Banana Tree sapling";
			
			init( this );
		} 

		public static void init( BananaTreeSapling plant )
		{
		...
		public BananaTreeSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class BananaTree : BaseTree
	{
		...
		[Constructable] 
		public BananaTree( Point3D pnt, Map map ) : base( 0xCAA ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Banana Tree";
...
*/
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( BananaTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( BananaTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
