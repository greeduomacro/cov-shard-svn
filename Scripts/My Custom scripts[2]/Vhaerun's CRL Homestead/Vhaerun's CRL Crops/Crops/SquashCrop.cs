...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable] 
		public SquashSeedling() : base( 0xC5E ) 
		{ 
			Movable = false; 
	...
	public class SquashCrop : BaseTree
	{
		...
		[Constructable] 
		public SquashCrop( Point3D pnt, Map map ) : base( Utility.RandomList( 0xC5F, 0xC60 ) ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = " Squash Plant";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( SquashCrop plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( SquashCrop Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
