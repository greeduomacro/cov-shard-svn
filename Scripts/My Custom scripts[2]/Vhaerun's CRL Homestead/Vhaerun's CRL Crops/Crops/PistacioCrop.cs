...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public PistacioTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public PistacioTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public PistacioTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public PistacioSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public PistacioSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class PistacioTree : BaseTree
	{
		...
		[Constructable] 
		public PistacioTree( Point3D pnt, Map map ) : base( 0xD99 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Pistacio Tree";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( PistacioTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( PistacioTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public PistacioTree( Serial serial ) : base( serial )
		{
		}
