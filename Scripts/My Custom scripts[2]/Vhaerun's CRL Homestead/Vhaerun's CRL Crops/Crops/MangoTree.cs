...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public MangoTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public MangoTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public MangoTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public MangoSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public MangoSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class MangoTree : BaseTree
	{
		...
		[Constructable] 
		public MangoTree( Point3D pnt, Map map ) : base( 0xDA6 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Mango Tree";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( MangoTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( MangoTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public MangoTree( Serial serial ) : base( serial )
		{
		}
