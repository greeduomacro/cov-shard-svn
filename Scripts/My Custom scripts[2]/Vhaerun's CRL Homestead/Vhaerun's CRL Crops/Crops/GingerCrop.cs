...
{ 
	...
	{ 
		...
		[Constructable]
		public GingerSeed() : this( 1 )
		{
		}

		[Constructable]
		public GingerSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public GingerSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public GingerSeedling( Mobile sower ) : base( 0xCB5 )
		{ 
			Movable = false; 
		...
		public GingerSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public GingerCrop( Mobile sower ) : base( 0xCC7 ) 
		{ 
			Movable = false; 
			Name = "Ginger Plant"; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( GingerCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
		...
		public GingerCrop( Serial serial ) : base( serial ) 
		{ 
		} 
