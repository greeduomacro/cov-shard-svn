...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public OrangeTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public OrangeTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public OrangeTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public OrangeSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public OrangeSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class OrangeTree : BaseTree
	{
		...
		[Constructable] 
		public OrangeTree( Point3D pnt, Map map ) : base( 0xDA2 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Orange Tree";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( OrangeTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( OrangeTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public OrangeTree( Serial serial ) : base( serial )
		{
		}
