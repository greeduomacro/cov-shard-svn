...
{ 
	...
	{ 
		...
		[Constructable]
		public CoffeeSeed() : this( 1 )
		{
		}

		[Constructable]
		public CoffeeSeed( int amount ) : base( 0xF27 )
		{
		...
		public CoffeeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public CoffeeSeedling( Mobile sower ) : base( Utility.RandomList ( 0xC51, 0xC52 ) ) 
		{ 
			Movable = false; 
		...
		public CoffeeSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public CoffeeCrop( Mobile sower ) : base( Utility.RandomList( 0xC53, 0xC54 ) ) 
		{ 
			Movable = false; 
			Name = "Coffee Plant";
			Hue = 0x46A; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( CoffeeCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
		...
		public CoffeeCrop( Serial serial ) : base( serial ) 
		{ 
		} 
