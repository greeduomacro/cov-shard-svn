...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public LemonTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public LemonTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public LemonTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public LemonSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public LemonSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class LemonTree : BaseTree
	{
		...
		[Constructable] 
		public LemonTree( Point3D pnt, Map map ) : base( 0xDA6 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Lemon Tree";
...
*/
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( LemonTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( LemonTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public LemonTree( Serial serial ) : base( serial )
		{
		}
