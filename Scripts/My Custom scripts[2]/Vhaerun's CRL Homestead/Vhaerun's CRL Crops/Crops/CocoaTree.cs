...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public CocoaTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public CocoaTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public CocoaTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public CocoaSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public CocoaSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class CocoaTree : BaseTree
	{
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( CocoaTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( CocoaTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public CocoaTree( Serial serial ) : base( serial )
		{
		}
