...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public PlumTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public PlumTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public PlumTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public PlumSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public PlumSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class PlumTree : BaseTree
	{
		...
		[Constructable] 
		public PlumTree( Point3D pnt, Map map ) : base( Utility.RandomList( 0x26EF, 0x26F0, 0x26F1, 0x26F2, 0x26F3 ) ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );

			int trunkID = ( Utility.RandomList( 0x26EE, 0x26ED ) );
...
*/
		...
		public PlumTree( Serial serial ) : base( serial )
		{
		}
