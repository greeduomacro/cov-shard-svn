...
{ 
	...
	{ 
		...
		[Constructable] 
		public ChiliPepperSeedling( Mobile sower ) : base( Utility.RandomList ( 0xCB6, 0xCB5 ) ) 
		{ 
			Movable = false; 
	...
	{ 
		...
		[Constructable] 
		public ChiliPepperCrop( Mobile sower ) : base( 0x234C ) 
		{ 
			Movable = false; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( ChiliPepperCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
