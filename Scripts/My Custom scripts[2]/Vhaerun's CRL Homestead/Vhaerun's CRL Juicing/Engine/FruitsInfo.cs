...
namespace Server.Items
{
	...
	public class JuicingResources
	{
		private static FruitsVarietyInfo[] m_FruitsInfo = new FruitsVarietyInfo[]
		{
			...
			new FruitsVarietyInfo( 0x0, 0,	"Blackberry",	FruitsVariety.Blackberries,	typeof( Blackberries ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Blueberry",	FruitsVariety.Blueberries,	typeof( Blueberries ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cherry",	FruitsVariety.Cherries,		typeof( Cherries ) ),
			new FruitsVarietyInfo( 0x0, 0,	"Cranberry",	FruitsVariety.Cranberries,	typeof( Cranberries ) ),
