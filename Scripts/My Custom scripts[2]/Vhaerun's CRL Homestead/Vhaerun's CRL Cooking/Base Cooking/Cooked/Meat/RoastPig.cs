...
namespace Server.Items
{
	...
	{
		[Constructable]
		public RoastPigNS() : this( 1 )
		{
		}

		[Constructable]
		public RoastPigNS( int amount ) : base( amount )
		{
			this.ItemID = 0x9BC;
		}

		public RoastPigNS( Serial serial ) : base( serial )
		{
		}
	...
	{
		[Constructable]
		public RoastPigEW() : this( 1 )
		{
		}

		[Constructable]
		public RoastPigEW( int amount ) : base( amount )
		{
			this.ItemID = 0x9BB;
		}

		public RoastPigEW( Serial serial ) : base( serial )
		{
		}
