...
namespace Server.Items
{
	public class UnbakedFruitPie : CookableFood
	{
		...
		[Constructable]
		public UnbakedFruitPie() : this( "", 0 )
		{
		}

		[Constructable]
		public UnbakedFruitPie( string Desc ) : this( Desc, 0 )
		{
		}

		[Constructable]
		public UnbakedFruitPie( int Color ) : this( "", Color )
		{
		}

		[Constructable]
		public UnbakedFruitPie( string Desc, int Color ) : base( 0x1042, 25 )
		{
			Weight = 1.0;
