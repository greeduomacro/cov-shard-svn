...
namespace Server.Engines.Craft
{
    public class DefBaking : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(ChocolateBar), "Desserts", "Chocolate Bar", 0.0, 100.0, typeof(BagOfCocoa), "Bag of Cocoa", 1, 1044253);
            ...
            AddRes(index, typeof(Tortilla), "Tortilla", 1, 1044253);
            AddRes(index, typeof(EnchiladaSauce), "Enchilada Suace", 1, 1044253);
            AddRes(index, typeof(FoodPlate), "Plate", 1, "You need a Plate!");
            SetNeedOven(index, true);
            ...
            index = AddCraft(typeof(VealParmesian), "Dinners", "Veal Parmesian", 0.0, 100.0, typeof(RawLambLeg), "Raw Leg of Lamb", 2, 1044253);
            AddRes(index, typeof(TomatoSauce), "Tomato Sauce", 1, 1044253);
            AddRes(index, typeof(CheeseWheel), "Cheese Wheel", 1, 1044253);
            AddRes(index, typeof(FoodPlate), "Plate", 1, "You need a Plate!");
            SetNeedOven(index, true);
