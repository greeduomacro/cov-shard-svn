...
namespace Server.Items
{
	...
	public class WinemakingResources
	{
		...
		{
			if ( variety >= GrapeVariety.CabernetSauvignon && variety <= GrapeVariety.Rice )
	...
	public class WineGrapeInfo
	{
		...
		public static readonly WineGrapeInfo Mango		= new WineGrapeInfo( 13, 0x000, "Mango" );
		public static readonly WineGrapeInfo Orange		= new WineGrapeInfo( 14, 0x000, "Orange" );
		public static readonly WineGrapeInfo Pear		= new WineGrapeInfo( 15, 0x000, "Pear" );
		public static readonly WineGrapeInfo Peach		= new WineGrapeInfo( 16, 0x000, "Peach" );
		//public static readonly WineGrapeInfo Blackberry		= new WineGrapeInfo( 18, 0x000, "Blackberry" );
		public static readonly WineGrapeInfo BlackRaspberry	= new WineGrapeInfo( 18, 0x000, "Black Raspberry" );
		...
		public static readonly WineGrapeInfo RedRaspberry		= new WineGrapeInfo( 19, 0x000, "Red Raspberry" );
		public static readonly WineGrapeInfo Strawberry		= new WineGrapeInfo( 20, 0x000, "Strawberry" );
		public static readonly WineGrapeInfo Watermelon		= new WineGrapeInfo( 21, 0x000, "Watermelon" );
		public static readonly WineGrapeInfo Rice		= new WineGrapeInfo( 22, 0x000, "Rice" );
