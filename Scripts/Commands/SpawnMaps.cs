...
namespace Server.Gumps
{
    ...
    public class TermurGump : Gump
    {
            ...
            : base(50, 50)
        {
            ...
            //Map names
            AddLabel(35, 51, 246, "Crimson Veins");
            ...
            AddLabel(35, 101, 200, "Tomb of Kings");
            AddLabel(35, 126, 200, "Underworld");
            AddLabel(35, 151, 200, "Abyss");
            AddLabel(35, 176, 200, "Atoll Blend");
            AddLabel(35, 201, 246, "Chicken Chase");
            AddLabel(35, 226, 246, "City Residential");
            ...
            //Map names
            AddLabel(35, 51, 246, "Coral Desert");
            AddLabel(35, 76, 246, "Fisherman's Reach");
            ...
            AddLabel(35, 76, 200, "Vendors");
            AddLabel(35, 101, 200, "Royal City");
            AddLabel(35, 126, 200, "Holy City");
            // AddLabel(35, 151, 200, "");
            // AddLabel(35, 176, 200, "");
            // AddLabel(35, 201, 200, "");
            // AddLabel(35, 226, 200, "");
                ...
                default:
                    {
                        ...
                        if (info.ButtonID == 1)
                        {
                            ...
                            if (Selections.Contains(101) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/crimsonveins.map", prefix));
                            }
                            if (Selections.Contains(102) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/enslavedgoblins.map", prefix));
                            }
                            if (Selections.Contains(103) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/fireislandruins.map", prefix));
                            }
                            if (Selections.Contains(104) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/fracturedcity.map", prefix));
                            }
                            if (Selections.Contains(105) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/landsofthelich.map", prefix));
                            }
                            if (Selections.Contains(106) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/lavacaldera.map", prefix));
                            }
                            if (Selections.Contains(107) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/passageoftears.map", prefix));
                            }
                            if (Selections.Contains(108) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/secretgarden.map", prefix));
                            }
                            if (Selections.Contains(109) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/cavernofthediscarded.map", prefix));
                            }
                            if (Selections.Contains(110) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/clanscratch.map", prefix));
                            }
                            if (Selections.Contains(111) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/tombofkings.map", prefix));
                            }
                            if (Selections.Contains(112) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/underworld.map", prefix));
                            }
                            if (Selections.Contains(113) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/abyss.map", prefix));
                            }
                            if (Selections.Contains(114) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/atollblend.map", prefix));
                            }
                            if (Selections.Contains(115) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/chickenchase.map", prefix));
                            }
                            if (Selections.Contains(116) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/cityresidential.map", prefix));
                            }
                            if (Selections.Contains(117) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/coraldesert.map", prefix));
                            }
                            if (Selections.Contains(118) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/fishermansreach.map", prefix));
                            }
                            if (Selections.Contains(119) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/gatedisle.map", prefix));
                            }
                            if (Selections.Contains(120) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/highplains.map", prefix));
                            }
                            if (Selections.Contains(121) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/kepetchwaste.map", prefix));
                            }
                            if (Selections.Contains(122) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/lavalake.map", prefix));
                            }
                            if (Selections.Contains(123) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/lavapitpyramid.map", prefix));
                            }
                            if (Selections.Contains(124) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/lostsettlement.map", prefix));
                            }
                            if (Selections.Contains(125) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/northernsteppe.map", prefix));
                            }
                            if (Selections.Contains(126) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/raptorisle.map", prefix));
                            }
                            if (Selections.Contains(127) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/slithvalley.map", prefix));
                            }
                            if (Selections.Contains(128) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/spiderisland.map", prefix));
                            }
                            if (Selections.Contains(129) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/talonpoint.map", prefix));
                            }
                            if (Selections.Contains(130) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/treefellowcourse.map", prefix));
                            }
                            if (Selections.Contains(131) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/voidisle.map", prefix));
                            }
                            if (Selections.Contains(132) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/walledcircus.map", prefix));
                            }
                            if (Selections.Contains(133) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/waterfallpoint.map", prefix));
                            }
                            ...
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/royalcity.map", prefix));
                            }
                            if (Selections.Contains(136) == true)
                            {
                                CommandSystem.Handle(from, String.Format("{0}Spawngen termur/holycity.map", prefix));
                            }
                        }
