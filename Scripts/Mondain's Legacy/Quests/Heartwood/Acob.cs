...
namespace Server.Engines.Quests
{
	...
	{				
		...
		{
			public InternalObjective() : base( typeof( SerpentsFangAssassin ), "male serpent's fang assassins", 10, "TheCitadel" )
			{
			}
	...
	{				
		...
		private class InternalObjective : SlayObjective
		{
			public InternalObjective() : base( typeof( DragonsFlameMage ), "male dragon's flame mages", 10, "TheCitadel" )
			{
			}
	...
	{				
		...
		private class InternalObjective : SlayObjective
		{
			public InternalObjective() : base( typeof( TigersClawThief ), "male tiger's claw thieves", 10, "TheCitadel" )
			{
			}
