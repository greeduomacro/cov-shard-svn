...
{
	public class MonkSuiSauJong : MondainQuester // Breaking Hand Dummy used in martial arts
	{	
		...
		[Constructable]
		public MonkSuiSauJong() : base( "Sui Sau Jong", "the monk" )
		{
		...
		public MonkSuiSauJong( Serial serial ) : base( serial )
		{
		}
