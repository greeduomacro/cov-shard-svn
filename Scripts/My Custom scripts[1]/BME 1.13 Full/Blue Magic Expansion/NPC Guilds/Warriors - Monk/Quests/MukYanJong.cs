...
{
	public class MonkMukYanJong : MondainQuester // Wooden Dummy used in martial arts
	{	
		...
		[Constructable]
		public MonkMukYanJong() : base( "Muk Yan Jong", "the monk" )
		{
		...
		public MonkMukYanJong( Serial serial ) : base( serial )
		{
		}
