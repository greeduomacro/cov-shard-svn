...
{
	public class MonkChingJong : MondainQuester // Balanced Dummy
	{	
		...
		[Constructable]
		public MonkChingJong() : base( "Ching Jong", "the monk" )
		{
		...
		public MonkChingJong( Serial serial ) : base( serial )
		{
		}
