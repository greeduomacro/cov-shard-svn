	...
	public class HeadlessHorseman : BaseCreature
	{
		...
		public virtual void ThrowPumpkin_Callback( object state )
		{
			...
			for ( int i = 0; i < count; ++i )
			{
				...
				PumpkinHeadBomb pumpkin = new PumpkinHeadBomb();
		...
		public override bool OnBeforeDeath()
		{
			...
			{
				case 0: PackItem( new HeadlessHorsemanArm() ); break;
                case 1: PackItem( new PumpkinBombM() ); break;
                case 2: PackItem( new SmellyPumpkinBombS() ); break;
			}

			//PackItem( new LootTokenCheck() );
