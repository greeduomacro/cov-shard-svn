...
{
	[CorpseName( "The Evil Misses Claus Corpes" )]
	public class EvilMsClaus1 : BaseCreature
	{
		...
		[Constructable]
		public EvilMsClaus1() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public override void OnDamage( int amount, Mobile from, bool willKill )
		{
			if ( from != null && from != this && !m_InHere )
			{
				...
				MovingEffect( from, 0x232A, 10, 0, false, false, 0, 0 );
				PlaySound( 0x491 );
		...
		public EvilMsClaus1( Serial serial ) : base( serial )
		{
		}
