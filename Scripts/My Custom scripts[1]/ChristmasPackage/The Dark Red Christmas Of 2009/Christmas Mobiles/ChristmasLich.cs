...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasLich" )]
              public class ChristmasLich : Lich
              {
                                 [Constructable]
                                    public ChristmasLich() : base()
                            {
                                               Name = "ChristmasLich";
                                               Hue = 38;
                                               //Body = 24; // Uncomment these lines and input values
                                               //BaseSoundID = 0x3E9; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasLich( Serial serial ) : base( serial )
                      {
                      }
