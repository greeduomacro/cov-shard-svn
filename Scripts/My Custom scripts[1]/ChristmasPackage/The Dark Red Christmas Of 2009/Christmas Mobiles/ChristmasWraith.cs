...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasWraith" )]
              public class ChristmasWraith : Wraith
              {
                                 [Constructable]
                                    public ChristmasWraith() : base()
                            {
                                               Name = "ChristmasWraith";
                                               Hue = 38;
                                               //Body = 26; // Uncomment these lines and input values
                                               //BaseSoundID = 0x482; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasWraith( Serial serial ) : base( serial )
                      {
                      }
