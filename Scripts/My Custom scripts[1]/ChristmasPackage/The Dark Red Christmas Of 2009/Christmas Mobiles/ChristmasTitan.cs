...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasTitan" )]
              public class ChristmasTitan : Titan
              {
                                 [Constructable]
                                    public ChristmasTitan() : base()
                            {
                                               Name = "ChristmasTitan";
                                               Hue = 64;
                                               //Body = 76; // Uncomment these lines and input values
                                               //BaseSoundID = 609; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasTitan( Serial serial ) : base( serial )
                      {
                      }
