...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasSkeletalKnight" )]
              public class ChristmasSkeletalKnight : SkeletalKnight
              {
                                 [Constructable]
                                    public ChristmasSkeletalKnight() : base()
                            {
                                               Name = "ChristmasSkeletalKnight";
                                               Hue = 64;
                                               //Body = 147; // Uncomment these lines and input values
                                               //BaseSoundID = 451; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasSkeletalKnight( Serial serial ) : base( serial )
                      {
                      }
