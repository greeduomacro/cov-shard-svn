   ...
   { 
	...
	{ 
      ...
      public override void OnSpeech( SpeechEventArgs e ) 
      {
      	...
      	{
      	if ( ( e.Speech.ToLower() == "santa" ) )//was sellpet
	     {
      ...
      public override void OnMovement( Mobile m, Point3D oldLocation )
		{
			...
			if ( m.Alive && m is PlayerMobile )
			{
				...
				if ( InRange( pm, 3 ) && !InRange( oldLocation, 3 ) )
				{
					...
					SantasGift2009 sg = pm.Backpack.FindItemByType( typeof ( SantasGift2009 ) ) as SantasGift2009;
				...
				if( dropped is SantasGift2009 )
            
         		{
				    ...
				    this.PrivateOverheadMessage( MessageType.Regular, 1153, false, "I would like  the gift from my Reindeer, not "+dropped.Amount+".", mobile.NetState );
         			...
         			mobile.AddToBackpack( new SantasGiftBag2009() );
		            mobile.SendGump( new SantaClausFinishGump( mobile ) );
         			return true;
         		}
         		else if( dropped is SantasGift2009 )
         		{
