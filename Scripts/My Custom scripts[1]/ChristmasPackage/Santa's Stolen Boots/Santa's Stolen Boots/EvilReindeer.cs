...
namespace Server.Mobiles
{
	...
	public class EvilReindeer : BaseCreature
	{
		[Constructable]
		public EvilReindeer() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Marty the evil reindeer";
		...
		public EvilReindeer( Serial serial ) : base( serial )
		{
		}
