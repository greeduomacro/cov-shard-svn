...
{
	[CorpseName( "a fire rock steed corpse" )]
	public class FireRockSteed : BaseMount
    {
		...
		[Constructable]
		public FireRockSteed() : this( "a fire rock steed" )
		{
		}

		[Constructable]
		public FireRockSteed( string name ) : base( name, 0xBE, 0x3E9E, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0xA8;
		...
		public FireRockSteed( Serial serial ) : base( serial )
		{
		}
