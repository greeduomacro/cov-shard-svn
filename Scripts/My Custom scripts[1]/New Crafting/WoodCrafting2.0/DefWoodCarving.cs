...
namespace Server.Engines.Craft
{
	public class DefWoodCarving : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( SeaHorseStatue ), "Statuettes", "a Sleek Sea Horse", 110.0, 120.0, typeof( DriftWood ), "Drift Wood", 10, 1053098 );
			AddCraft( typeof( Abacus ), "Statuettes", "an Abacus", 100.0, 120.0, typeof( DriftWood ), "Drift Wood", 10, 1053098 );
