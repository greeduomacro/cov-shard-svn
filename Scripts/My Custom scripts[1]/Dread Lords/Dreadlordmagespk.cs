...
namespace Server.Mobiles
{
	...
	public class dreadlordmagespk : BaseCreature
	{
	...
	private static bool m_Talked;
		...
		[Constructable]
		public dreadlordmagespk () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			AddItem( new Cloak( 268 ) );
			AddItem( new HalfApron( 268 ) );
			AddItem( new BodySash( 268 ) );
		...
		public dreadlordmagespk( Serial serial ) : base( serial )
		{
		}
