...
namespace Server.Mobiles
{
	...
	public class Dreadmerc : BaseCreature
	{
	...
	private static bool m_Talked;
		...
		[Constructable]
		public Dreadmerc () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Swords, 95.0 );
		...
		public Dreadmerc( Serial serial ) : base( serial )
		{
		}
