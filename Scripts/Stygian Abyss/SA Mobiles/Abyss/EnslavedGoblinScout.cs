...
namespace Server.Mobiles
{
	...
	public class EnslavedGoblinScout : BaseCreature
	{
		...
		public EnslavedGoblinScout() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Physical, 41, 42 );
			SetResistance( ResistanceType.Fire, 30, 33 );
			SetResistance( ResistanceType.Cold, 30, 35 );
			SetResistance( ResistanceType.Poison, 20, 25 );
			SetResistance( ResistanceType.Energy, 14, 18 );

			SetSkill( SkillName.MagicResist, 98.6, 100.5 );
			SetSkill( SkillName.Tactics, 84.0, 86.9 );
			SetSkill( SkillName.Anatomy, 86.0, 87.3 );
			SetSkill( SkillName.Wrestling, 109.2, 110.7 );
