...
namespace Server.Mobiles
{
	...
	public class EnslavedGoblinMage : BaseCreature
	{
		...
		public EnslavedGoblinMage() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Physical, 29, 35 );
			SetResistance( ResistanceType.Fire, 36, 37 );
			SetResistance( ResistanceType.Cold, 35, 39 );
			...
			SetSkill( SkillName.MagicResist, 145.0, 149.7 );
			SetSkill( SkillName.Tactics, 89, 90 );
			SetSkill( SkillName.Anatomy, 87, 90 );
			SetSkill( SkillName.Wrestling, 93.4, 96 );
