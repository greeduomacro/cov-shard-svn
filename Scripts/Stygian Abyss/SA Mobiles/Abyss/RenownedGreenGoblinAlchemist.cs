...
namespace Server.Mobiles
{
	...
	public class RenownedGreenGoblinAlchemist : BaseCreature
	{
		//public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public RenownedGreenGoblinAlchemist() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (Utility.RandomDouble() < 0.05)
            {
                switch (Utility.Random(2))
                {
                    ...
                    case 1: c.DropItem(new ObsidianEarrings()); break;
                    case 2: c.DropItem(new TheImpalersPick()); break;
                }
            }
        }
		...
		public RenownedGreenGoblinAlchemist( Serial serial ) : base( serial )
		{
		}
