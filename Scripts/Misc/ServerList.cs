...
namespace Server.Misc
{
	public class ServerList
	{
        ...
        public static readonly string Address = "68.40.54.220";// "71.227.82.205";//"68.61.220.192";//"127.0.0.1";
		public static readonly string ServerName = "Champion of Virtues SA/HS";
