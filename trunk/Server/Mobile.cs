...
namespace Server
{
	...
	public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable, ISpawnable
	{
		...
		private bool m_Sleep; // SA Edit Mysticism Sleep
		private ParalyzedTimer m_ParaTimer;
		private SleepTimer m_SleepTimer; // SA Edit Mysticism Sleep
		...
		public virtual bool Sleep
		{
			...
			set
			{
				if( m_Sleep != value )
				{
					...
					//this.SendLocalizedMessage( m_Sleep ? 502381 : 502382 );

					if( m_SleepTimer != null )
					{
		...
		public void DoSleep( TimeSpan duration )
		{
			if( !m_Sleep )
			{
				Sleep = true;
				...
				m_SleepTimer = new SleepTimer( this, duration );
				m_SleepTimer.Start();
			}
		}
