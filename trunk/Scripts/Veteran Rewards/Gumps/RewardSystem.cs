...
namespace Server.Engines.VeteranRewards
{
	public class RewardSystem
	{
			...
			m_Lists = new RewardList[]
				{
					new RewardList( RewardInterval, 1, new RewardEntry[]
					{
                        ...
                        new RewardEntry( houseAddOns,    1062096, typeof( MiniHouseDeed)),
						#endregion
						...
						#region Veteran Rewards
						new RewardEntry( houseAddOns,    1062692, typeof( MiniHouseDeed ), MiniHouseType.MalasMountainPass ),
					    new RewardEntry( houseAddOns,    1072216, typeof( MiniHouseDeed ), MiniHouseType.ChurchAtNight ),
					...
					new RewardList( RewardInterval, 2, new RewardEntry[]
					{
                        ...
                        //new RewardEntry( miscellaneous,  1078835, typeof( BlueSoulstone ) )
						#endregion
					} ),
					new RewardList( RewardInterval, 3, new RewardEntry[]
					{
                        ...
                        //new RewardEntry( miscellaneous,  1078834, typeof( SoulStone ) ),
		...
		private static void EventSink_Login( LoginEventArgs e )
		{
			...
			if ( e.Mobile.SkillsCap == 10000 || e.Mobile.SkillsCap == 10050 || e.Mobile.SkillsCap == 10100 || e.Mobile.SkillsCap == 10150 || e.Mobile.SkillsCap == 10200 )
			{
				if ( level > 4 )
					level = 4;
				else if ( level < 0 )
				...
				if ( SkillCapRewards )
					e.Mobile.SkillsCap = 10000 + (level * 50);
				else
					e.Mobile.SkillsCap = 10000;
			}
