...
namespace Server.Gumps
{
	public class PremiumSpawnerMainGump : Gump
	{
		...
		public PremiumSpawnerMainGump( CommandEventArgs e ) : base( 50,50 )
		{
			...
			AddBackground( 0, 0, 267, 470, 5054 );

            AddHtml(8, 8, 250, 42, "        PREMIUM SPAWNER<BR>" + "by Nerun (update Magerly666) v5.2.0", true, false);
            
			AddBlackAlpha( 8, 58, 250, 50 );

			AddBlackAlpha( 8, 112, 250, 130 );

			AddBlackAlpha( 8, 280, 250, 130 );

			AddButton( 220, 405, 0x158A, 0x158B, 10000, GumpButtonType.Reply, 1 ); //Quit Button
//Options---------------------
			AddLabel( 10, 60, 52, "WORLD CREATION OPTIONS" );
			AddLabel( 10, 116, 52, "SPAWN OPTIONS" );
			AddLabel( 10, 280, 52, "UNLOAD SPAWNS" );

			AddLabel( 45, 80, 52, "Create World gump" );
			AddButton( 25, 80, 0x845, 0x846, 10001, GumpButtonType.Reply, 0 );

			AddLabel( 45, 134, 52, "Spawn Trammel" );
			AddButton( 25, 134, 0x845, 0x846, 10002, GumpButtonType.Reply, 0 );

			AddLabel( 45, 154, 52, "Spawn Felucca" );
			AddButton( 25, 154, 0x845, 0x846, 10003, GumpButtonType.Reply, 0 );

			AddLabel( 45, 174, 52, "Spawn Ilshenar" );
			AddButton( 25, 174, 0x845, 0x846, 10004, GumpButtonType.Reply, 0 );

			AddLabel( 45, 194, 52, "Spawn Malas" );
			AddButton( 25, 194, 0x845, 0x846, 10104, GumpButtonType.Reply, 0 );

			AddLabel( 45, 214, 52, "Spawn Tokuno" );
			AddButton( 25, 214, 0x845, 0x846, 10105, GumpButtonType.Reply, 0 );

            AddLabel(170, 132, 52, "Spawn TerMur");
            AddButton(150, 132, 0x845, 0x846, 10106, GumpButtonType.Reply, 0);

            AddLabel( 45, 298, 52, "Unload Trammel spawns" );
			AddButton( 25, 298, 0x845, 0x846, 10005, GumpButtonType.Reply, 0 );

			AddLabel( 45, 316, 52, "Unload Felucca spawns" );
			AddButton( 25, 316, 0x845, 0x846, 10006, GumpButtonType.Reply, 0 );

			AddLabel( 45, 334, 52, "Unload Ilshenar spawns" );
			AddButton( 25, 334, 0x845, 0x846, 10007, GumpButtonType.Reply, 0 );

			AddLabel( 45, 354, 52, "Unload Malas spawns" );
			AddButton( 25, 354, 0x845, 0x846, 10107, GumpButtonType.Reply, 0 );

			AddLabel( 45, 374, 52, "Unload Tokuno spawns" );
			AddButton( 25, 374, 0x845, 0x846, 10108, GumpButtonType.Reply, 0 );

            AddLabel(45, 394, 52, "Unload Termur spawns");
            AddButton(25, 394, 0x845, 0x846, 10109, GumpButtonType.Reply, 0);
            
            AddLabel( 120, 430, 200, "1/3" );
			AddButton( 145, 430, 0x15E1, 0x15E5, 0, GumpButtonType.Page, 2 );
// -----------------------------------------
			AddPage(2);
