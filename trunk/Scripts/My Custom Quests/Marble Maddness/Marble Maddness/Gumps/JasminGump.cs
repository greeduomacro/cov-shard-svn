...
{ 
   ...
   { 
      ...
      { 
         CommandSystem.Register( "JasminGump", AccessLevel.GameMaster, new CommandEventHandler( JasminGump_OnCommand ) ); 
      } 
...
"<BASEFONT COLOR=YELLOW>Then the Lizardmen all ran back down the steps and into the tunnel.<BR><BR>But I'm too scared to go back down there in case the Lizardmen are hiding and waiting for me - they could catch me and eat me all up<BR>" +
