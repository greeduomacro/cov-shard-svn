...
{
	public class JasminCheckerBoard : BaseBoard
	{
		...
		[Constructable]
		public JasminCheckerBoard() : base( 0xFA6 )
		{
		    Name = "Jasmin's Checkerboard";
			Weight = 1.0;
		...
		public JasminCheckerBoard( Serial serial ) : base( serial )
		{
		}
