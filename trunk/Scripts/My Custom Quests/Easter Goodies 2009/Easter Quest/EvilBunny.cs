...
{
	[CorpseName( "an Evil Bunny corpse" )]	
	public class EvilBunny : BaseCreature
	{
		private DateTime m_NextFire;
		[Constructable]
		public EvilBunny() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Evil Bunny";
			Body = 0xCD;
			Hue = 230;
		...
		public EvilBunny( Serial serial ) : base( serial )
		{
		}
