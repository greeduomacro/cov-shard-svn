...
namespace Server.Mobiles
{
	...
	public class CrystalHydra1 : BaseCreature
	{
		[Constructable]
		public CrystalHydra1() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public CrystalHydra1( Serial serial ) : base( serial )
		{
		}
