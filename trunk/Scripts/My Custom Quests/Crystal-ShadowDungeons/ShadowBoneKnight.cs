...
{
	[CorpseName( "a Shadow Bone Knight corpse" )]
	public class ShadowBoneKnight : BaseCreature
	{
		[Constructable]
		public ShadowBoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Shadow Bone Knight";
			Body = 57;
        ...
        public ShadowBoneKnight(Serial serial)
            : base(serial)
		{
		}
