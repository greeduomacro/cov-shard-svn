...
namespace Server.Items
{
	...
	public class ElvenCloakOfHiding : Cloak 
	{ 
		...
		[Constructable] 
		public ElvenCloakOfHiding() : base( 0x309 ) 
		{ 
			Name = "Elven Cloak of the Unseen"; 
			DefineMods();
		} 
		...
		public ElvenCloakOfHiding( Serial serial ) : base( serial ) 
		{ 
			DefineMods();
