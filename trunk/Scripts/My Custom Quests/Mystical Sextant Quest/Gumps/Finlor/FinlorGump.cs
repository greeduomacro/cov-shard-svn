...
//			<BASEFONT COLOR=#7B6D20>			
            ...
            AddButton(135, 390, 0xF7, 0xF8, 1, GumpButtonType.Reply, 0);
            AddButton(250, 390, 241, 242, 0, GumpButtonType.Reply, 1);
//--------------------------------------------------------------------------------------------------------------
      } 
      ...
      { 
         ...
         { 
            ...
            { 
               ...
               from.AddToBackpack(new LetterToOrthal());
               from.AddToBackpack(new SeaChest());
               break; 
            }
            ...
            case 0:
            {
                ...
                Item a = from.Backpack.FindItemByType(typeof(SeaChest));
                Item b = from.Backpack.FindItemByType(typeof(LetterToOrthal));
                if (a != null && b != null)
                {
                    a.Delete();
                    b.Delete();
                ...
                from.CloseGump(typeof(FinlorGump));
                break;
            }
