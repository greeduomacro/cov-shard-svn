...
{
	[CorpseName( "an evil fan dancer corpse" )]
	public class EvilFanDancer : BaseCreature
	{
		[Constructable]
		public EvilFanDancer() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Evil Fan dancer";
			Body = 247;
            Hue = 1643;
			BaseSoundID = 0x372;
		...
		public EvilFanDancer( Serial serial ) : base( serial )
		{
		}
