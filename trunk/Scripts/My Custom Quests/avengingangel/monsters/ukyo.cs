...
{
	[CorpseName( "a corpse" )]
	public class Ukyo : BaseCreature
	{
		[Constructable]
		public Ukyo() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Ukyo";
			Body = 400;
			BaseSoundID = 609;
		...
		public Ukyo( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDeath(Container c)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (a != null)
                {
                    ...
                    pm.AddToBackpack(new BrokenPlateArms());
            ...
            else if (m is BaseCreature)
            {
                ...
                if (bc.Controlled == true)
                {
                    ...
                    if (a != null)
                    {
						bc.ControlMaster.AddToBackpack(new BrokenPlateArms());
