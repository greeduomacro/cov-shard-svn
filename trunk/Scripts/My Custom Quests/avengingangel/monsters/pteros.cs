...
{
	[CorpseName( "a corpse" )]
	public class Pteros : BaseCreature
	{
		[Constructable]
		public Pteros() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Pteros";
			Body = 400;
		...
		public Pteros( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDeath(Container c)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (a != null)
                {
                    ...
                    pm.AddToBackpack(new WornGloves());
            ...
            else if (m is BaseCreature)
            {
                ...
                if (bc.Controlled == true)
                {
                    ...
                    if (a != null)
                    {
						bc.ControlMaster.AddToBackpack(new WornGloves());
