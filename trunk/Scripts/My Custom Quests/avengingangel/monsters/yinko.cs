...
{
	[CorpseName( "a corpse" )]
	public class Yinko : BaseCreature
	{
		[Constructable]
		public Yinko() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Yinko";
			Body = 400;
		...
		public Yinko( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDeath(Container c)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (a != null)
                {
                    ...
                    pm.AddToBackpack(new SplitHelm());
            ...
            else if (m is BaseCreature)
            {
                ...
                if (bc.Controlled == true)
                {
                    ...
                    if (a != null)
                    {
						bc.ControlMaster.AddToBackpack(new SplitHelm());
