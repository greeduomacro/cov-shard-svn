...
{
	public class CharlesQuestGump9 : Gump
		{
		public CharlesQuestGump9( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "Now you must return to the Fallen Warrior.", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump9 ) );
					break;
				}
