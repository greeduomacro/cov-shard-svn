...
{
	public class CharlesQuestGump2 : Gump
	{
		public CharlesQuestGump2( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "Charles sees you and a glimmer appears in his eyes!<bR><br><i>I wasn't sure if you perished! You cannot rest now! Continue your quest! The next monsters are the Arctic Ogre Lords.</i>", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.AddToBackpack (new AOLContract ());
					break;
				}
