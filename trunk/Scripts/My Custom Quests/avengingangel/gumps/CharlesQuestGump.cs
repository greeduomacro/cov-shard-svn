...
{
	public class CharlesQuestGump : Gump
	{
		
		public CharlesQuestGump( Mobile m) : base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "<i>Who are you?? Why are you bothering me?</i><br><br>He looked at you annoyed but puzzled and he says:<br><br><i>I see you have spoken to my daughter's fallen fiance</i><br><br><i>Are you here on his behalf? <br><br>If so, you will have a very long and treacherous journey before you.<br><br>If you accept, you will face powerful monsters and you must avenge my daughter's fiance.<br><br>Please accept this contract and start your quest but you must make haste! The first monsters you will face are White Wyrms.", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump2 ) );
					from.AddToBackpack(new WhiteWyrmContract());
					break;
				}
