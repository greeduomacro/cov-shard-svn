...
{
	public class CharlesQuestGump6 : Gump
	{
		public CharlesQuestGump6( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "You see Charles weeping of joy at the thought of seeing his daughter once more. All you hear him whispering is:<br><br> <i>Liches...liches now...</i>", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump6 ) );
					from.AddToBackpack (new LichContract ());
					break;
				}
