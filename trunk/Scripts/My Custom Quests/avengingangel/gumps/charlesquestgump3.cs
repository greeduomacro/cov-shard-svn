...
{
	public class CharlesQuestGump3 : Gump
	{
		public CharlesQuestGump3( Mobile m ): base( 0, 0 )
		{
			this.Closable=false;
			...
			this.AddHtml( 157, 181, 345, 279, "<i>Hope has begun to live in my heart once more! I have never allowed myself to feel hope or to think that I would once again see my daughter! <br><br>She tried to cast a spell to raise her beloved when he fell in battle but the evil Khashina cast a magic trap on his body and ensnared her soul into his death.<br><br>Please continue the quest, I beg you! You must now face dragons! ", false, true);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			switch( info.ButtonID )
			{
				case 0:
				{
					...
					from.CloseGump( typeof( CharlesQuestGump3 ) );
					from.AddToBackpack (new DragonContract ());
					break;
				}
