...
namespace Server.Items
{
	...
	public class WhiteWyrmContract : Item
	{
		...
		[Constructable]
		public WhiteWyrmContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public WhiteWyrmContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new WhiteWyrmContractGump( from, this ) );
			} 
			else 
		    {
		...
		public WhiteWyrmContract( Serial serial ) : base( serial ) 
		{ 
		} 
