...
namespace Server.Items
{
	...
	public class SuccubusContract : Item
	{
		...
		[Constructable]
		public SuccubusContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public SuccubusContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new SuccubusContractGump( from, this ) );
			} 
			else 
		    {
		...
		public SuccubusContract( Serial serial ) : base( serial ) 
		{ 
		} 
