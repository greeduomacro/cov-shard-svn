...
namespace Server.Items
{
	...
	public class AOLContract : Item
	{
		...
		[Constructable]
		public AOLContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public AOLContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new AOLContractGump( from, this ) );
			} 
			else 
		    {
		...
		public AOLContract( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public string GetRandomMonster(int genre)
	{
		...
		{
          default:
          case 0: return "Arctic Ogre Lord"; 
		}
	}
  }
}
