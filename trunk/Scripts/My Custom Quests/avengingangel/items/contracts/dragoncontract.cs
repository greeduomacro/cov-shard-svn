...
namespace Server.Items
{
	...
	public class DragonContract : Item
	{
		...
		[Constructable]
		public DragonContract() : base( 0x14EF )
		{
			Movable = true;
		...
		[Constructable]
		public DragonContract( string type, int atk) : base( 0x14F0 )
		{
			Movable = true;
			LootType = LootType.Blessed;
			Monster = type;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendGump( new DragonContractGump( from, this ) );
			} 
			else 
		    {
		...
		public DragonContract( Serial serial ) : base( serial ) 
		{ 
		} 
