...
{ 
   public class TSGump : Gump 
   { 
      public static void Initialize() 
      { 
         CommandSystem.Register( "TSGump", AccessLevel.GameMaster, new CommandEventHandler( TSGump_OnCommand ) ); 
      } 

      public static void TSGump_OnCommand( CommandEventArgs e ) 
      { 
         e.Mobile.SendGump( new TSGump( e.Mobile ) ); 
      } 

      public TSGump( Mobile owner ) : base( 50,50 ) 
      { 
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------Window size bar--------------------------------------------
			...
			AddLabel( 140, 60, 0x34, "Return of the Control Globe" );
			

			AddHtml( 107, 140, 300, 230, "<BODY>" +
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=WHITE>*Fenton glances up with a worried look in his eyes*<BR><BR>Please kind Traveler, could you assist me?<BR>" +                                                                    
...
//--------------------------------------------------------------------------------------------------------------
      ...
      { 
         ...
         switch (info.ButtonID)
         {
             case 1:
                 {
                     from.SendMessage("I'm glad you accepted this task and get those pieces back!");
                     from.CloseGump(typeof(TSGump));
                     from.AddToBackpack(new TSMarker());

                     break;
                 }
             case 0:
                 {
                     from.SendMessage("Such a pity, Hopefully someone will help me! COV will be lost without someones help!.");
                     from.CloseGump(typeof(TSGump));
                     break;
                 }
         }
