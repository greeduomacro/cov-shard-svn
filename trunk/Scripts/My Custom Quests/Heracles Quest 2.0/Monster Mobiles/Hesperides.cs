...
{
	[CorpseName( "Hesperides corpse" )]
	public class Hesperides : BaseCreature
	{

		[Constructable]
		public Hesperides() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Hesperides";
			Body = 266;
			BaseSoundID = 0x467;
		...
		public Hesperides( Serial serial ) : base( serial )
		{
		}
