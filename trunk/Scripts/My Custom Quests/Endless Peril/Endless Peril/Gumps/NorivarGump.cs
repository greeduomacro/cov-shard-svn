...
"<BASEFONT COLOR=YELLOW>I will craft you one if you would wish it, but the materials I require are very rare. They are called Ancient Granite Stones and can be found on Dartmoor Ponies that hang around the Doom entrance.<BR><BR>These are powerful beasts; not easily killed in battle. Should you retrieve 10 of these stones - I shall consider you worthy and will craft you a shield." +
						     "</BODY>", false, true);
