...
namespace Server.Mobiles
{
	...
	public class Steropes : BaseCreature
	{
		[Constructable]
		public Steropes() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "Steropes";
			Body = 75;
			BaseSoundID = 604;
		...
		public Steropes( Serial serial ) : base( serial )
		{
		}
