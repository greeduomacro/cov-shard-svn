...
{
	[CorpseName( "a Desert Terror corpse" )]
	public class DesertTerror : BaseChampion
	{
		public override ChampionSkullType SkullType{ get{ return ChampionSkullType.Power; } }

        public override Type[] UniqueList { get { return new Type[] { typeof(DeathsHead), typeof(WallofHungryMouths)}; } }

        public override Type[] SharedList { get { return new Type[] { typeof(TongueoftheBeast) }; } }

        public override Type[] DecorativeList { get { return new Type[] { typeof(EvilIdolSkull) }; } }
		
        public override MonsterStatuetteType[] StatueTypes { get { return new MonsterStatuetteType[] { }; } }

		[Constructable]
		public DesertTerror() : base( AIType.AI_Mage )
		{
            Body = 0x2F3;
            BaseSoundID = 0x174;
			Name = "The Desert Terror";
            Hue = 1045;
        ...
        public override void OnDeath(Container c)
        {
            ...
            if (Utility.RandomDouble() < 0.50)
            {
                ...
                {
                    case 0: AddToBackpack(new RisingColossusScroll()); break;
        ...
        public override void OnDamagedBySpell(Mobile caster)
        {
            if (this.Map != null && caster != this &&  caster is PlayerMobile && 0.20 > Utility.RandomDouble())
            {
                ...
                {
                    case 0: caster.Location = new Point3D(454, 3838, -43); break;
                    case 1: caster.Location = new Point3D(506, 3934, -43); break;
                    case 2: caster.Location = new Point3D(524, 3728, -44); break;
                    case 3: caster.Location = new Point3D(554, 3786, -43); break;
                    case 4: caster.Location = new Point3D(602, 3784, -42); break;
                }

                caster.SendMessage("You are being burned by the heat from the desert sand!");
        ...
        public void SpawnFollowers(Mobile target)
        {
            ...
            if ( Followers < 6)
            {
                ...
                for (int i = 0; i < newFollowers; ++i)
                {
                    ...
                    {
                        default:
                        case 0: follower = new StoneSlith(); break;
                        case 1: follower = new Slith(); break;
                    ...
                    for (int j = 0; !validLocation && j < 3; ++j)
                    {
        ...
        public override void OnActionCombat()
        {
            if (DateTime.Now > m_Delay)
            {
                ...
                m_Delay = DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(50, 60));      
            }

            base.OnActionCombat();
        }

		public DesertTerror( Serial serial ) : base( serial )
		{
		}
