...
namespace Server.Mobiles
{
	public class PrimevalLich : BaseChampion
	{
        ...
        public override Type[] UniqueList { get { return new Type[] { typeof(LightsRampart), typeof(ObiDiEnse), typeof(BansheesCall), typeof(CastOffZombieSkin), typeof(ProtectoroftheBattleMage), typeof(ChannelersDefender) }; } }
        ...
        public override void OnDamagedBySpell(Mobile attacker)
        {
             ...
             if (this.Map != null && attacker != this && 0.05 > Utility.RandomDouble())
            {
                ...
                switch (Utility.Random(4))
                {
                    ...
                    //case 4: attacker.Location = new Point3D(6949, 721, 35); break;
                    //case 5: attacker.Location = new Point3D(7016, 728, 46); break;
                    //case 6: attacker.Location = new Point3D(6968, 685, 32); break;
                    //case 7: attacker.Location = new Point3D(6996, 775, 44); break;
                }
