...
namespace Server.Mobiles
{
	...
	public class KepetchAmbusher : BaseCreature
	{
		...
		[Constructable]
		public KepetchAmbusher() : base( AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Kepetch aAmbusher";
			Body = 726;
           ...
           // SetSkill(SkillName.Ninjitsu, 90.0, 120.0);
            SetSkill(SkillName.Hiding, 107.4, 113.5);
            SetSkill(SkillName.Stealth, 107.7, 113.9);
		}
