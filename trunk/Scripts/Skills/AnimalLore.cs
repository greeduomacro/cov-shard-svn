...
namespace Server.SkillHandlers
{
	...
	public class AnimalLoreGump : Gump
	{
		...
		public AnimalLoreGump( BaseCreature c ) : base( 250, 50 )
		{
			...
			#region Mondain's Legacy
			if ( c is CuSidhe || c is AncientCuSidhe )
			{
            ...
            if (c is NecroSteed)
            {
                AddHtmlLocalized(153, 276, 160, 18, 1044109, LabelColor, false, false); // Necromancy
                AddHtml(320, 276, 35, 18, FormatSkill(c, SkillName.Necromancy), false, false);

                AddHtmlLocalized(153, 294, 160, 18, 1044092, LabelColor, false, false); // Spirit Speak
                AddHtml(320, 294, 35, 18, FormatSkill(c, SkillName.SpiritSpeak), false, false);
            }
            else if ( c is FairyDragon )
			{
				AddHtmlLocalized( 153, 276, 160, 18, 1044115, LabelColor, false, false ); // Mysticism
				AddHtml( 320, 276, 35, 18, FormatSkill( c, SkillName.Mysticism ), false, false );
