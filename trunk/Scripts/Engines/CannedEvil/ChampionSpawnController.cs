...
namespace Server.Engines.CannedEvil
{
    public class ChampionSpawnController : Item
    {
        ...
        private ArrayList m_TerMurSpawn;
        ...
        private SpawnRecord[] m_TerMur = new SpawnRecord[]
        {
            new SpawnRecord( (int)ChampionSpawnType.DesertTerror, 524, 3817, -44 ),//Desert Terror
        };
        ...
        public void Start()
        {
            ...
            foreach (ChampionSpawn cs in m_TerMurSpawn)
            {
                if (!cs.Deleted)
                    cs.Active = true;
            }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.WriteItemList(m_TerMurSpawn);
