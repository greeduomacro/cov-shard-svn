		...
		private static readonly ChampionSpawnInfo[] m_Table = new ChampionSpawnInfo[]
			{
				...
				#region SA
				new ChampionSpawnInfo( "AbyssalLair", typeof( AbyssalInfernal ), new string[]{ "Banisher", "Enforcer", "Eradicator" } , new Type[][]
				{																											// AbyssalLair
				...
				new ChampionSpawnInfo( "LichLand", typeof( PrimevalLich ), new string[]{ "Cleanser", "Expunger", "Depurator" } , new Type[][]
				{																											// LichLand
                ...
                new ChampionSpawnInfo( "DesertTerror", typeof( DesertTerror ), new string[]{ "Cleanser", "Expunger", "Depurator" } , new Type[][]
				{																											// Desert Massacre
					new Type[]{ typeof( EnragedEarthElemental ), typeof( RotWorm ) },												// Level 1
					new Type[]{ typeof( BloodWorm ), typeof( ToxicSlith ) },										        // Level 2
					new Type[]{ typeof( KepetchAmbusher ), typeof( Mimic ) },												// Level 3
					new Type[]{ typeof( Ballem ), typeof( Anlorvaglem ) }											        // Level 4
				} )
				#endregion
			};
