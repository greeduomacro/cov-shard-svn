...
namespace Server.Mobiles
{
	public class Paragon
	{
		...
		public static bool CheckConvert( BaseCreature bc, Point3D location, Map m )
		{
			...
			if ( bc is BaseChampion || bc is Harrower || bc is BaseVendor || bc is BaseEscortable || bc is Clone || bc is Gwenno || bc is Swoop || bc is LadyLissith || bc is LadySabrix || bc is Irk || bc is Guile || bc is Spite || bc is Silk || bc is Virulent || bc is FireBird || bc is Nightmare || bc is DryderSpider || bc is DeathJumpSpider || bc is FireBat )
				return false;
