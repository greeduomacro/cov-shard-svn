...
namespace Server.Engines.Craft
{
	...
	public class CraftItem
	{
        ...
        private bool m_NeedCarpetloom;
        private bool m_NeedPotteryWheel;///////////////////////////////////////////////
        ...
        public bool NeedCarpetloom
        {
            get { return m_NeedCarpetloom; }
            set { m_NeedCarpetloom = value; }
        }

        public bool NeedPotteryWheel////////////////////////////////////////
        {
            get { return m_NeedPotteryWheel; }
            set { m_NeedPotteryWheel = value; }
        }
        ...
        private static int[] m_CarpetLooms = new int[]
			{
				
				0x1063, 0x1536, //  CarpetLoomEast (Need 1 loom pc and belt for needCarpetLoom)
				0x1066, 0x1535  // CarpetLoomSouth (Need 1 loom pc and belt for needCarpetLoom)
			};

        private static int[] m_PotteryWheels = new int[]///////////////////////////////////////////////////////////
			{
		...
		private static Type[][] m_TypesTable = new Type[][]
			{						
				...
				new Type[]{ typeof( Cloth ), typeof( UncutCloth ), typeof( Basket ), typeof( RoundBasket ) },
				new Type[]{ typeof( CheeseWheel ), typeof( CheeseWedge ), typeof( BaseContainer ) },
				new Type[]{ typeof( Pumpkin ), typeof( SmallPumpkin ), typeof( SoftenedReeds ), typeof( DryReeds ) },
		...
		private static Type[] m_ColoredItemTable = new Type[]
			{
				...
				typeof( BaseWeapon ), typeof( BaseArmor ), typeof( BaseClothing ), typeof( CraftableFurniture ), typeof( Basket ), typeof( RoundBasket ), 
				typeof( BaseJewel ), typeof( DragonBardingDeed ), typeof( BaseFurniture ), typeof( BaseShield ), typeof( BaseInstrument ), typeof( SoftenedReeds ),
				typeof( PlantPigment ), typeof( DryReeds ), typeof( PlantClippings )
			};
		...
		private static Type[] m_ColoredResourceTable = new Type[]
			{
				...
				typeof( BaseGranite ), typeof( BaseScales ), typeof(BaseContainer ),
				typeof( PlantClippings ), typeof( DryReeds ), typeof( SoftenedReeds ), typeof( PlantPigment )
			};
        ...
        public bool ConsumeRes(Mobile from, Type typeRes, CraftSystem craftSystem, ref int resHue, ref int maxAmount, ConsumeType consumeType, ref object message, bool isFailure)
        {
            ...
            if (m_NeedCarpetloom && !Find(from, m_CarpetLooms))
            {
                message = "You must be near a Carpet Loom to make that.";
                return false;
            }

            if (m_NeedPotteryWheel && !Find(from, m_PotteryWheels))
            {
                message = "You must be near a Pottery Wheel to make pottery.";
                return false;
            }
