...
namespace Server.Engines.Craft
{
	...
	public abstract class CraftSystem
	{
        ...
        public void SetNeedCarpetloom(int index, bool needCarpetloom)
        {
            CraftItem craftItem = m_CraftItems.GetAt(index);
            craftItem.NeedCarpetloom = needCarpetloom;
        }

        public void SetNeedPotteryWheel(int index, bool needPotteryWheel)///////////////////////////////////////////
        {
            CraftItem craftitem = m_CraftItems.GetAt(index);
            craftitem.NeedPotteryWheel = needPotteryWheel;
        }
