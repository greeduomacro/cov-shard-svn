	...
	public class DefAlchemy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
            ...
            if (Core.SA)
            {
                ...
                index = AddCraft(typeof(SoftenedReeds), "Plant Pigments", 1112249, 75.0, 100.0, typeof(ScouringToxin), 1112292, 2, "You don't have enough scouring toxin to make this.");
