	...
	public class Mining : HarvestSystem
	{
			...
			res = new HarvestResource[]
				{
					...
					new HarvestResource( 70.0, 27.5, 107.5, 1007074, typeof( ShadowIronOre ),	typeof( ShadowIronGranite ),		typeof( ShadowIronElemental ) ),
					new HarvestResource( 75.0, 30.0, 110.0, 1007075, typeof( CopperOre ),		typeof( CopperGranite ),		typeof( CopperElemental ) ),
					new HarvestResource( 80.0, 32.5, 112.5, 1007076, typeof( BronzeOre ),		typeof( BronzeGranite ),		typeof( BronzeElemental ) ),
					new HarvestResource( 85.0, 35.0, 115.0, 1007077, typeof( GoldOre ),		typeof( GoldGranite ),			typeof( GoldenElemental ) ),
					new HarvestResource( 90.0, 37.5, 117.5, 1007078, typeof( AgapiteOre ),		typeof( AgapiteGranite ),		typeof( AgapiteElemental ) ),
					new HarvestResource( 95.0, 40.0, 120.0, 1007079, typeof( VeriteOre ),		typeof( VeriteGranite ),		typeof( VeriteElemental ) ),
					new HarvestResource( 99.0, 42.5, 122.5, 1007080, typeof( ValoriteOre ),		typeof( ValoriteGranite ),		typeof( ValoriteElemental ) ),
					new HarvestResource( 100.0, 45.0, 125.0, "You dig some silver ore and put it in your backpack" , typeof( SilverOre ), typeof( SilverGranite ), typeof( SilverElemental ) ),
				    ...
				    new HarvestResource( 105.0, 47.5, 127.5, "You dig some jade ore and put it in your backpack" , typeof( JadeOre ), typeof( JadeGranite ), typeof( JadeElemental ) ),
					new HarvestResource( 110.0, 50.0, 130.0, "You dig some moonstone ore and put it in your backpack" , typeof( MoonstoneOre ), typeof( MoonstoneGranite ), typeof( MoonstoneElemental ) ),
					new HarvestResource( 115.0, 55.0, 132.5, "You dig some sunstone ore and put it in your backpack" , typeof( SunstoneOre ), typeof( SunstoneGranite ), typeof( SunstoneElemental ) ),
			...
			veins = new HarvestVein[]
				{
					...
					new HarvestVein( 04.0, 0.5, res[10], res[0] ), // Jade
					new HarvestVein( 03.6, 0.5, res[11], res[0] ), // Moonstone
					new HarvestVein( 03.2, 0.5, res[12], res[0] ), // Sunstone
			...
			if ( tool is GargoylesPickaxe && def == m_OreAndStone && 0.1 > Utility.RandomDouble() )
			{
				...
				if ( res == resource && res.Types.Length >= 3 )
				{
					try
					{
						...
						BaseCreature spawned = Activator.CreateInstance( res.Types[3], new object[]{ 25 } ) as BaseCreature;
		...
		private static int[] m_MountainAndCaveTiles = new int[]
			...
			// Adding 0x8000 instead of 0x4000 for static harvest targets
				0x853B, 0x853C, 0x853D, 0x853E, 0x853F, 0x8540, 0x8541,
				0x8542, 0x8543, 0x8544,	0x8545, 0x8546, 0x8547, 0x8548,
				0x8549, 0x854A, 0x854B, 0x854C, 0x854D, 0x854E,	0x854F
				#endregion
			};
