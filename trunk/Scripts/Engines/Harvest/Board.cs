...
namespace Server.Items
{
    public abstract class BaseBoards : Item, ICommodity
    {
        ...
        string ICommodity.Description
        {
            get
            {
                return String.Format(Amount == 1 ? "{0} board" : "{0} boards", Amount, CraftResources.GetName(m_Resource).ToLower());
            }
        }
		...
		{ 
			get
			{
				if ( m_Resource >= CraftResource.Oak && m_Resource <= CraftResource.Mahogany )
					return 1075052 + ( (int)m_Resource - (int)CraftResource.Oak );
        ...
        public BaseBoards(CraftResource resource)
            : this(resource, 1)
        {
        }
        ...
        public BaseBoards(Serial serial)
            : base(serial)
        {
        }
    ...
    public class PineBoard : BaseBoards
    {
        ...
        public PineBoard(int amount)
            : base(CraftResource.Pine, amount)
        {
        }
    ...
    public class CedarBoard : BaseBoards
    {
        ...
        public CedarBoard(int amount)
            : base(CraftResource.Cedar, amount)
        {
        }
    ...
    public class MahoganyBoard : BaseBoards
    {
        ...
        public MahoganyBoard(int amount)
            : base(CraftResource.Mahogany, amount)
        {
        }
