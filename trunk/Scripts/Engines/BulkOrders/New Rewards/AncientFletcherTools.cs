...
namespace Server.Items
{
	...
	public class AncientFletcherTools: BaseTool
	{
		...
		[Constructable]
		public AncientFletcherTools( int bonus, int uses ) : base( uses, 0x1022 )
		{
			Name = "Ancient Fletcher Tools";
			m_Bonus = bonus;
			Weight = 8.0;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Bonus != 0 )
				list.Add( 1060451, "#1023005\t{0}", m_Bonus.ToString() ); // ~1_skillname~ +~2_val~
		}
