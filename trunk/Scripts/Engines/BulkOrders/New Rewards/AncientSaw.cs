...
namespace Server.Items
{
	...
	public class AncientSaw : BaseTool
	{
		private int m_Bonus;
		...
		[Constructable]
		public AncientSaw( int bonus ) : this( bonus, 600 )
		{
		}
		
		[Constructable]
		public AncientSaw( int bonus, int uses ) : base( uses, 0x1034 )
		{
			Name = "Ancient Saw";
			m_Bonus = bonus;
			Weight = 8.0;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_Bonus != 0 )
				list.Add( 1060451, "#1002054\t{0}", m_Bonus.ToString() ); // ~1_skillname~ +~2_val~
		}
		
		public AncientSaw( Serial serial ) : base( serial )
		{
		}
