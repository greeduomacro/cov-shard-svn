...
namespace Server.Mobiles
{
	...
	public class DarkGuardian : BaseCreature
	{
		...
		public DarkGuardian() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetHits( 1150, 1180 );//Was 150 to 180
			...
			SetResistance( ResistanceType.Physical, 120 );///Was 40 to 50
			...
			SetSkill( SkillName.MagicResist, 50.1, 70.0 );///Was 50 to 70
			SetSkill( SkillName.Tactics, 50.1, 70.0 );

			Fame = 5000;
			Karma = -5000;

			VirtualArmor = 80;/// Was 50
			PackNecroReg( 15, 25 );
