			...
			private static PigmentInfo[] m_Table = new PigmentInfo[]
				{
                    ...
                    new PigmentInfo( /*PigmentType.FreshPeach,*/ 0x0145, "Fresh Peach" ),
					new PigmentInfo( /*PigmentType.Rose,*/ 0x04B9, "Rose" ),
					new PigmentInfo( /*PigmentType.Silver,*/ 0x03E9, "Silver" ),
					new PigmentInfo( /*PigmentType.PaleBlue,*/ 0x024F, "Pale Blue" ),
					new PigmentInfo( /*PigmentType.DeepBrown,*/ 0x03F0, "Deep Brown" ),
					new PigmentInfo( /*PigmentType.BurntBrown,*/ 0x041A, "Burnt Brown" ),
					new PigmentInfo( /*PigmentType.PaleOrange,*/ 0x002E, "Pale Orange" ),
					new PigmentInfo( /*PigmentType.LightGreen,*/ 0x01C8, "Light Green" ),
					new PigmentInfo( /*PigmentType.ChaosBlue,*/ 0x0005, "Chaos Blue" ),
					new PigmentInfo( /*PigmentType.NobleGold,*/ 0x0227, "Noble Gold" ),
