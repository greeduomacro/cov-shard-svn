...
namespace Server.Spells
{
	public abstract class Spell : ISpell
	{
		...
		private static TimeSpan NextSpellDelay = TimeSpan.FromSeconds( 0.50 );
		private static TimeSpan AnimateDelay = TimeSpan.FromSeconds( 1.0 );
		...
		public virtual double GetDamageScalar( Mobile target )
		{
			...
			if( !Core.AOS )	//EvalInt stuff for AoS is handled elsewhere
			{
				...
				*/
				...
				scalar += (m_Caster.Skills[CastSkill].Value - 60.0) / 400.0;
        ...
        public virtual double SkillMaxGain
        {
            get
            {
		...
		public virtual double CastDelaySecondsPerTick { get { return 0.175; } }
		public virtual TimeSpan CastDelayMinimum { get { return TimeSpan.FromSeconds( 0.175 ); } }
