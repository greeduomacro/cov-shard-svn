...
namespace Server.Spells.Druid
{
  	public class EnchantedGroveSpell : DruidicSpell
	{
      ...
      public override double RequiredSkill{ get{ return 75; } }
     ...
     public override void OnCast()
           ...
           public void Target( IPoint3D p )
      {
         ...
         {
             Caster.SendMessage("You can't use this spell in Felucca!");
             return;
        // }
         //else if (Caster.IsBlueMage)
         //{
             //Caster.SendMessage("Blue Mages can't cast this spell!");
         ...
         { 
			...
			for ( int i = 0; i < list.Count; ++i )
			{
				...
				if ( friendly )
				{
					...
					m.Mana += (1 + (m_Caster.Karma / 90000));
					//m.Hits += (1 + (m_Caster.Karma / 45000));
				}
			} 
            } 
         }
