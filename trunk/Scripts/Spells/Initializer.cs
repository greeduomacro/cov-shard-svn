		...
		public static void Initialize()
		{
			...
			if ( Core.AOS )
			{
				...
				Register( 209, typeof( Chivalry.SacredJourneySpell ) );
					...
					// Druid Spells
        		Register( 301, typeof( Druid.FireflySpell ) );
				...
				Register( 306, typeof( Druid.SwarmOfInsectsSpell ) );
         		Register( 307, typeof( Druid.VolcanicEruptionSpell ) );
			 	Register( 308, typeof( Druid.TreefellowSpell ) );
			 	Register( 309, typeof( Druid.StoneCircleSpell ) );
				Register( 310, typeof( Druid.EnchantedGroveSpell ) );
				Register( 311, typeof( Druid.LureStoneSpell ) );
				Register( 312, typeof( Druid.NaturesPassageSpell ) );
				Register( 313, typeof( Druid.MushroomGatewaySpell ) );
				Register( 314, typeof( Druid.RestorativeSoilSpell ) );
                //Register( 316, typeof( Druid.ShieldOfEarthSpell));
