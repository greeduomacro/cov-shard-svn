...
namespace Server.Items
{
    ...
    public class BlackWellAddonDeed : BaseAddonDeed
    {
        public override BaseAddon Addon
        {
            get
            {
                return new BlackWellAddon();
            }
        }

        [Constructable]
        public BlackWellAddonDeed()
        {
            Name = "Black Well";
        }

        public BlackWellAddonDeed(Serial serial)
            : base(serial)
        {
        }
				...
				else
				{
					...
					switch( Utility.RandomMinMax( 1, 5 ) )
					{
						...
						case 4:  
							...
							break;
						case 5:  
							msg = "You drink from the pure well and quiet dreams of childhood pass through your mind.";
							break;
					}
