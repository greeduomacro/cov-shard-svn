...
namespace Server.Mobiles
{
	...
	public class dreadlordarcherspk : BaseCreature
	{
	...
	private static bool m_Talked;
		...
		[Constructable]
		public dreadlordarcherspk () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public dreadlordarcherspk( Serial serial ) : base( serial )
		{
		}
