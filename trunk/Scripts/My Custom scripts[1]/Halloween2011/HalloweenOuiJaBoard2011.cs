...
{  
	public class HalloweenOuiJaBoard2011 : Item
	{
           	[Constructable]
           	public HalloweenOuiJaBoard2011()
           	{
			ItemID = 4013;
           		Name = "a oui-ja board";
			...
			Hue = 1137;
           	...
           	[Constructable]
           	public HalloweenOuiJaBoard2011(int amount)
           	{
           	}

           	public HalloweenOuiJaBoard2011(Serial serial) : base( serial )
           	{
           	}
