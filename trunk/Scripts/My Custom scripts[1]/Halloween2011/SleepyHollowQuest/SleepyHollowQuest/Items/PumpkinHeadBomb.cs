...
{
	public class PumpkinHeadBomb : Item, ICarvable
	{
		private PumpkinTimer m_Timer;

		[Constructable]
		public PumpkinHeadBomb() : base( 0xC6A )
		{
			Movable = false;
        ...
        public PumpkinHeadBomb(Serial serial)
            : base(serial)
		{
		}
		...
		private class PumpkinTimer : Timer
		{
			...
			protected override void OnTick()
			{
				...
				for ( int i = 0; i < list.Count; ++i )
				{
					...
					AOS.Damage( mob, mob, Utility.RandomMinMax( 15, 25 ), 0, 100, 0, 0, 0 );
