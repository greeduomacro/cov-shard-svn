...
namespace Server.Mobiles
{
	...
	public class BloodGolem : BaseCreature
	{
		[Constructable]
		public BloodGolem() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8 )
		{
			Name = "a blood golem";
			Body = 304;
			Hue = 1157;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			if ( from.InRange( this, 2 ) )
				new GolemHealTimer( this, from, 3 ).Start();
			else
		...
		public BloodGolem( Serial serial ) : base( serial )
		{
		}
