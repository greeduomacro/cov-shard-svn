...
{
	public class SlowSpell : BlueSpell
	{
		private static SpellInfo m_Info = new SpellInfo( "Slow Spell", "", 230 );

		public override int PowerLevel{ get{ return 5; } }

		private Mobile m_Caster;

		public SlowSpell( Mobile from ) : base( from, m_Info )
		{
			m_Caster = from;
		}
		...
		public static bool IsSlowed( Mobile m )
		{
			return m_Table.ContainsKey( m.Serial );
		}

		public static void BeginSlow( Mobile m )
		{
			...
			m.SendMessage( "The world seems to be moving a bit faster." );
		}

		public static void EndSlow( Mobile m )
		{
			if ( m_Table.ContainsKey( m.Serial ) )
			{
		...
		{
			private SlowSpell m_Owner;

			public InternalTarget( SlowSpell owner ) : base( 12, false, TargetFlags.Harmful )
			{
				m_Owner = owner;
			}
