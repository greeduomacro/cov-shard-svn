...
namespace Server.Mobiles
{
	...
	public class BlueMalboro : BlueMonster
	{
		public override TimeSpan CastDelay{ get{ return TimeSpan.FromSeconds( 30.0 ); } }
		public override Type SpellToCast{ get{ return typeof( BadBreathSpell ); } }

		public BlueMalboro() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.6, 1.2 )
		{
			Name = "Malboro";
			Body = 780;
			Hue = 1193;
		...
		public BlueMalboro( Serial serial ) : base( serial )
		{
		}
