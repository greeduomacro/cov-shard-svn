...
namespace Server.Engines.Harvest
{
	public class FireRockMining : HarvestSystem
    {
        ...
        private static int[] m_LavaTiles = new int[]
                 ...
                 0x32B0, 0x32B1, 0x343B, 0x343C, 0x343D, 0x343E, 0x343F,
                 0x3440, 0x3441, 0x3442, 0x3443, 0x3444, 0x3445, 0x3446,
                 0x3447, 0x3448, 0x3449, 0x344A, 0x344B, 0x344C, 0x344D,
                 0x344E, 0x344F, 0x3450, 0x3451, 0x3452, 0x3453, 0x3454,
                 0x3455, 0x3456, 0x3457, 0x3462, 0x3463, 0x3464, 0x3465,
                 0x3466, 0x3468, 0x3469, 0x346A, 0x346B, 0x346C, 0x3547,
                 0x3548, 0x3549, 0x354A, 0x354B, 0x354C 
            };
		#endregion
	}
}