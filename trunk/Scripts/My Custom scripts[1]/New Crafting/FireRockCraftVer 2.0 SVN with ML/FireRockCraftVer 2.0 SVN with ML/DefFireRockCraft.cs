...
namespace Server.Engines.Craft
{
    public class DefFireRockCraft : CraftSystem
    {
        ...
        {
            get { return 1044007; } // <CENTER>BLACKSMITH MENU</CENTER>
        }
        ...
        public override void InitCraftList()
        {
            ...
            index = AddCraft(typeof(FemaleFireRockChest), "Armor", "FemaleFireRockChest", 96.0, 115.0, typeof(LargeFireRock), "LargeFireRock", 10, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 15, "You dont have enough FireRock");
            index = AddCraft(typeof(FireRockChest), "Armor", "FireRockChest", 96.0, 115.0, typeof(LargeFireRock), "LargeFireRock", 10, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 15, "You dont have enough FireRock");
            index = AddCraft(typeof(FireRockArms), "Armor", "FireRockArms", 85.0, 110.0, typeof(LargeFireRock), "LargeFireRock", 10, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 10, "You dont have enough FireRock");
            index = AddCraft(typeof(FireRockLegs), "Armor", "FireRockLegs", 85.0, 110.0, typeof(LargeFireRock), "LargeFireRock", 10, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 10, "You dont have enough FireRock");
            index = AddCraft(typeof(FireRockGloves), "Armor", "FireRockGloves", 80.0, 105.0, typeof(LargeFireRock), "LargeFireRock", 8, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 8, "You dont have enough FireRock");
            index = AddCraft(typeof(FireRockGorget), "Armor", "FireRockGorget", 80.0, 105.0, typeof(LargeFireRock), "LargeFireRock", 5, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 5, "You dont have enough FireRock");
            AddCraft(typeof(FireRockHelm), "Armor", "FireRockHelm", 75.0, 95.0, typeof(LargeFireRock), "LargeFireRock", 6, "You dont have enough FireRock");
            index = AddCraft(typeof(FlameShield), "Armor", "FlameShield", 75.0, 95.0, typeof(LargeFireRock), "LargeFireRock", 7, "You dont have enough FireRock");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 10, "You dont have enough FireRock");
            index = AddCraft(typeof(CrystalineFireChest), "Armor", "CrystalineFireChest", 97.0, 115.0, typeof(CrystalineFire), "CrystalineFire", 15, "You dont have enough CrystalineFire");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 15, "You dont have enough FireRock");
            index = AddCraft(typeof(CrystalineFireArms), "Armor", "CrystalineFireArms", 86.0, 110.0, typeof(CrystalineFire), "CrystalineFire", 10, "You dont have enough CrystalineFire");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 10, "You dont have enough FireRock");
            index = AddCraft(typeof(CrystalineFireLegs), "Armor", "CrystalineFireLegs", 86.0, 110.0, typeof(CrystalineFire), "CrystalineFire", 12, "You dont have enough CrystalineFire");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 10, "You dont have enough FireRock");
            index = AddCraft(typeof(CrystalineFireGloves), "Armor", "CrystalineFireGloves", 82.0, 105.0, typeof(CrystalineFire), "CrystalineFire", 8, "You dont have enough CrystalineFire");
            AddRes(index, typeof(SmallFireRock), "SmallFireRock", 8, "You dont have enough FireRock");
            AddCraft(typeof(CrystalineFireHelm), "Armor", "CrystalineFireHelm", 80.0, 95.0, typeof(CrystalineFire), "CrystalineFire", 6, "You dont have enough CrystalineFire");
           ...
           // SetUseAllRes(index, true);
            ...
            AddCraft(typeof(FireRockSteedBardingDeed), "Item", "FireRockSteedBardingDeed", 85.0, 95.0, typeof(SmallFireRock), "SmallFireRock", 30, "You dont have enough FireRock");
               #endregion
