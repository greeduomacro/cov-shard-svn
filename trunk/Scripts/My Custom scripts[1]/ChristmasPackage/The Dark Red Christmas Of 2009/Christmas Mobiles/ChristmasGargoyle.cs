...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasGargoyle" )]
              public class ChristmasGargoyle : Gargoyle
              {
                                 [Constructable]
                                    public ChristmasGargoyle() : base()
                            {
                                               Name = "ChristmasGargoyle";
                                               Hue = 38;
                                               //Body = 4; // Uncomment these lines and input values
                                               //BaseSoundID = 372; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasGargoyle( Serial serial ) : base( serial )
                      {
                      }
