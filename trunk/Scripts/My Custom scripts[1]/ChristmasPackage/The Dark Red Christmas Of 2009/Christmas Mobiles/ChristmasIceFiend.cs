...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasIceFiend" )]
              public class ChristmasIceFiend : IceFiend
              {
                                 [Constructable]
                                    public ChristmasIceFiend() : base()
                            {
                                               Name = "ChristmasIceFiend";
                                               Hue = 64;
                                               //Body = 43; // Uncomment these lines and input values
...
public ChristmasIceFiend( Serial serial ) : base( serial )
                      {
                      }
