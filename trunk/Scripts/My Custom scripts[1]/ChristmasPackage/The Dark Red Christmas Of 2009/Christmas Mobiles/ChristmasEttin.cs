...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasEttin" )]
              public class ChristmasEttin : Ettin
              {
                                 [Constructable]
                                    public ChristmasEttin() : base()
                            {
                                               Name = "ChristmasEttin";
                                               Hue = 64;
                                               //Body = 18; // Uncomment these lines and input values
                                               //BaseSoundID = 367; // To use your own custom body and sound.
                                               SetStr(400, 450);
                                               SetDex(210, 250);
                                               SetInt(310, 330);
...
public ChristmasEttin( Serial serial ) : base( serial )
                      {
                      }
