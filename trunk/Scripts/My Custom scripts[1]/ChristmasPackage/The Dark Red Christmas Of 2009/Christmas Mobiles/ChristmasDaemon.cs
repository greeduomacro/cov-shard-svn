...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasDaemon" )]
              public class ChristmasDaemon : Daemon
              {
                                 [Constructable]
                                    public ChristmasDaemon() : base()
                            {
                                               Name = "ChristmasDaemon";
                                               Hue = 38;
...
public ChristmasDaemon( Serial serial ) : base( serial )
                      {
                      }
