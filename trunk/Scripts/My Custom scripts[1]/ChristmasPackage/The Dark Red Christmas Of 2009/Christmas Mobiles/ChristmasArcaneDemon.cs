...
namespace Server.Mobiles
              ...
              {
              [CorpseName( " corpse of a ChristmasArcaneDemon" )]
              public class ChristmasArcaneDemon : ArcaneDaemon
              {
                                 [Constructable]
                                    public ChristmasArcaneDemon() : base()
                            {
                                SetStr(400, 450);
                                SetDex(210, 250);
                                SetInt(310, 330);
...
public ChristmasArcaneDemon( Serial serial ) : base( serial )
                      {
                      }
