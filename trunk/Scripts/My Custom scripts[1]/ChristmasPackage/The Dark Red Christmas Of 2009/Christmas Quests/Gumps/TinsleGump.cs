...
{ public class TinsleGump : Gump { 
public static void Initialize() { 
CommandSystem.Register( "TinsleGump", AccessLevel.GameMaster, new CommandEventHandler( TinsleGump_OnCommand ) ); 
}
private static void TinsleGump_OnCommand( CommandEventArgs e ) 
{
e.Mobile.SendGump( new TinsleGump( e.Mobile ) ); } 
public TinsleGump( Mobile owner ) : base( 50,50 ) 
{
//----------------------------------------------------------------------------------------------------
AddPage( 0 );AddImageTiled(  54, 33, 369, 400, 2624 );AddAlphaRegion( 54, 33, 369, 400 );AddImageTiled( 416, 39, 44, 389, 203 );
//--------------------------------------Window size bar--------------------------------------------
AddImage( 97, 49, 9005 );AddImageTiled( 58, 39, 29, 390, 10460 );AddImageTiled( 412, 37, 31, 389, 10460 );
AddLabel( 140, 60, 0x34, "Tinsle The Xmas Elf" );
//----------------------/----------------------------------------------/
...
"<BASEFONT COLOR=YELLOW>and Collect me 30 blue Xmas Presents &<BR>" +
