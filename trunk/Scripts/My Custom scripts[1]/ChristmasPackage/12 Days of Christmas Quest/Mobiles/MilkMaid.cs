...
{
    [CorpseName("A Maid Of Milking")]
	public class MilkMaid : BaseCreature
	{
		[Constructable]
		public MilkMaid() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "A Maid Of Milking";
