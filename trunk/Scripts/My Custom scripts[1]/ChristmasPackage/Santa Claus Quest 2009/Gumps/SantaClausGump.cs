...
//--------------------------------------Window size bar--------------------------------------------
			...
			AddLabel( 140, 60, 0x34, "Lost Reindeer Quest 2009" );
...
"<BASEFONT COLOR=WHITE>Not to forget Rudolph!<BR><BR>" +
"<BASEFONT COLOR=WHITE>Find them and return each one here to me. When you return just say my name to get my attention, as I am so busy preparing for this Holiday Season.<BR>" +
