...
{
	[CorpseName( "an Arctic Hiryu corpse" )]
	public class ArcticHiryu : BaseCreature
	{
		...
		[Constructable]
        public ArcticHiryu() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
            Name = "an Arctic Hiryu";
            Body = 243;
			Hue = 1153;
		...
		public ArcticHiryu( Serial serial )
			: base( serial )
		{
		}
