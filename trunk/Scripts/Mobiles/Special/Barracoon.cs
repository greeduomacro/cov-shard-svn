...
namespace Server.Mobiles
{
	public class Barracoon : BaseChampion
	{
		...
		// http://www.uoguide.com/Barracoon_the_Piper
		// When Barracoon spawns, he appears in his human form and casts spells very quickly, (FC?)
		// although these spells lack the Evaluating Intelligence to do damage. These spells do 
		// more to disrupt his target than damage.
