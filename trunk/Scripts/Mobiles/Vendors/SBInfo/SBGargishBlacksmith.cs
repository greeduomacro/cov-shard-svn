...
{ 
	public class SBGargishBlacksmith : SBInfo 
	{ 
		private List<GenericBuyInfo> m_BuyInfo = new InternalBuyInfo(); 
		private IShopSellInfo m_SellInfo = new InternalSellInfo(); 

		public SBGargishBlacksmith() 
		{ 
		} 
		...
		{ 
			...
			{ 	
				Add( new GenericBuyInfo( typeof( IronIngot ), 5, 160, 0x1BF2, 0 ) );
				Add( new GenericBuyInfo( typeof( Tongs ), 13, 14, 0xFBB, 0 ) );
                Add( new GenericBuyInfo( typeof( BlackSmithBox ), 500, 20, 0xE80, 0x488 ) );
                Add( new GenericBuyInfo( typeof( ScaleBox ), 500, 20, 0xE80, 0x455 ) );
                Add( new GenericBuyInfo( typeof( RunicHouse), 500, 20, 0xE80, 0x58));
                ...
                Add( new GenericBuyInfo( typeof( LargePlateShield ), 50, 20, 0x4204, 0 ) );
                Add( new GenericBuyInfo( typeof( MediumPlateShield ), 123, 20, 0x4203, 0 ) );
                Add( new GenericBuyInfo( typeof( SmallPlateShield ), 231, 20, 0x4202, 0 ) );
				Add( new GenericBuyInfo( typeof( WoodenKiteShield ), 70, 20, 0x1B78, 0 ) );
				Add( new GenericBuyInfo( typeof( GargishChaosShield ), 350, 20, 0x4228, 0 ) );
                Add( new GenericBuyInfo( typeof( GargishOrderShield ), 350, 20, 0x422A, 0 ) );
                Add( new GenericBuyInfo( typeof( GargishKiteShield), 123, 20, 0x4201, 0));
                Add( new GenericBuyInfo( typeof( GargishWoodenShield), 70, 20, 0x4200, 0));
                ...
                Add(new GenericBuyInfo(typeof(GargishPlateChest), 104, 20, 0x030A, 0));
                Add(new GenericBuyInfo(typeof(GargishPlateLegs), 243, 20, 0x030E, 0));
                Add(new GenericBuyInfo(typeof(GargishPlateArms), 188, 20, 0x0308, 0));
                Add(new GenericBuyInfo(typeof(GargishPlateKilt), 155, 20, 0x030C, 0));
