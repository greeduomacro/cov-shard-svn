		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
                ...
                if ( Core.SA )
                    ...
                    Add( new GenericBuyInfo( typeof( MysticBook ), 1000, 999, 0x2D9D, 0 ) );

				Add( new GenericBuyInfo( typeof( ScribesPen ), 8, 10, 0xFBF, 0 ) );
				Add( new GenericBuyInfo( typeof( BlankScroll ), 5, 160, 0x0E34, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( BlackPearl ), 5, 160, 0xF7A, 0 ) );
				Add( new GenericBuyInfo( typeof( Bloodmoss ), 5, 160, 0xF7B, 0 ) );
				Add( new GenericBuyInfo( typeof( Garlic ), 3, 160, 0xF84, 0 ) );
				Add( new GenericBuyInfo( typeof( Ginseng ), 3, 160, 0xF85, 0 ) );
				Add( new GenericBuyInfo( typeof( MandrakeRoot ), 3, 160, 0xF86, 0 ) );
				Add( new GenericBuyInfo( typeof( Nightshade ), 3, 160, 0xF88, 0 ) );
				Add( new GenericBuyInfo( typeof( SpidersSilk ), 3, 160, 0xF8D, 0 ) );
				Add( new GenericBuyInfo( typeof( SulfurousAsh ), 3, 160, 0xF8C, 0 ) );
                ...
                if ( Core.SA )
                {
                    Add( new GenericBuyInfo( typeof( DragonBlood ), 60, 160, 0x4077, 0 ) );
					Add( new GenericBuyInfo( typeof( Bone ), 10, 160, 0xF7E, 0 ) );
                    Add( new GenericBuyInfo( typeof( FertileDirt), 15, 160, 0xF81, 0 ) );
                    Add( new GenericBuyInfo( typeof( DaemonBone), 15, 160, 0xF80, 0 ) );
				...
				for ( int i = 0; i < circles*2 && i < types.Length; ++i )
				{
					int itemID = 0x2D9E + i;
