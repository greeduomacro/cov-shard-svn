...
{
	public class NinjitsuDealer : BaseVendor
	{
		...
		[Constructable]
		public NinjitsuDealer() : base( "the Ninjitsu Dealer" )
		{
			SetSkill( SkillName.ArmsLore, 64.0, 80.0 );
			SetSkill( SkillName.Ninjitsu, 64.0, 85.0 );
        ...
        public NinjitsuDealer(Serial serial)
            : base(serial)
		{
		}
