...
{
	public class GargishTailor : BaseVendor
	{
		...
		[Constructable]
		public GargishTailor() : base( "the Gargish tailor" )
		{
		...
		{
			m_SBInfos.Add( new SBGargishTailor() );
		}
		...
		public GargishTailor( Serial serial ) : base( serial )
		{
		}
