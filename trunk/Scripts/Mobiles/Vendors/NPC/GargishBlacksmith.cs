...
{
	public class GargishBlacksmith : BaseVendor
	{
		...
		[Constructable]
		public GargishBlacksmith() : base( "the Gargish blacksmith" )
		{
		...
		public override void InitSBInfo()
		{
			...
			m_SBInfos.Add( new SBGargishBlacksmith() );
			if ( IsTokunoVendor )
			{
		...
		public override void InitOutfit()
		{
			...
			Item item = ( Utility.RandomBool() ? null : new Server.Items.GargishPlateChest() );
			...
			if ( item == null )
				AddItem( new Server.Items.GargoyleHalfApron() );
		...
		public GargishBlacksmith( Serial serial ) : base( serial )
		{
		}
