...
namespace Server.Engines.Quests
{
	...
	{		
		...
		public static Item FletcherRunic()
		{
			...
			{
				case 0: return new RunicFletcherTool( CraftResource.Oak, 45 );
				case 1: return new RunicFletcherTool( CraftResource.Ash, 35 );
				case 2: return new RunicFletcherTool( CraftResource.Yew, 25 );
		...
		public static Item CarpRunic()
		{
			switch ( Utility.Random( 4 ) )
			{
				case 0: return new RunicDovetailSaw( CraftResource.Oak, 45 );
				case 1: return new RunicDovetailSaw( CraftResource.Ash, 35 );
				case 2: return new RunicDovetailSaw( CraftResource.Yew, 25 );
