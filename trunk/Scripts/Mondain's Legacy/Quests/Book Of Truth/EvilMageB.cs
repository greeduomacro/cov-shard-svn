...
{ 
	...
	public class EvilMageB : BaseCreature 
	{ 
		[Constructable] 
		public EvilMageB() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{ 
		...
		public EvilMageB( Serial serial ) : base( serial )
		{
		}
