...
{
	public class WizardReadingGlassesFaction : Glasses
	{
		...
		[Constructable]
		public WizardReadingGlassesFaction( Faction faction, Mobile mobile ) : base()
		{
			Hue = 0x6;
			m_Owner = mobile;
		...
		public WizardReadingGlassesFaction( Serial serial ) : base( serial )
		{
		}
