...
{
     public class OrderShieldMuseumofVesperReplicaFaction : OrderShield
		{
		...
		public override int InitMaxHits{ get{ return 255; } }
              ...
              [Constructable]
              public OrderShieldMuseumofVesperReplicaFaction( Faction faction, Mobile mobile ) : base()
				{

                    Weight = 1;
                    Name = "Order Shield - Museum of Vesper Replica";
                    Hue = 918;
					m_Owner = mobile;
              ...
              public OrderShieldMuseumofVesperReplicaFaction( Serial serial ) : base( serial )
                      {
                      }
