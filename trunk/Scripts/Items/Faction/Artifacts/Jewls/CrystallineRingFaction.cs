...
{
	public class CrystallineRingFaction : GoldRing
	{
		...
		[Constructable]
		public CrystallineRingFaction( Faction faction, Mobile mobile )
		{
		...
		public CrystallineRingFaction( Serial serial ) : base( serial )
		{
		}
		#region FactionOwner	
