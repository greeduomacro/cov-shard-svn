...
{
    public class FeyLeggingsFaction: ChainLegs
	{
		#region FactionOwner
        ...
        [Constructable]
        public FeyLeggingsFaction( Faction faction, Mobile mobile ) : base()
		{
            Weight = 1;
            Name = "Fey Leggings";
            Hue = 0;
		...
		public FeyLeggingsFaction( Serial serial ) : base( serial )
        {
        }
