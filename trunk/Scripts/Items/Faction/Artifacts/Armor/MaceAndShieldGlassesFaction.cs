...
{
	public class MaceAndShieldGlassesFaction : Glasses
	{
		...
		[Constructable]
		public MaceAndShieldGlassesFaction( Faction faction, Mobile mobile ) : base()
		{
			Hue = 0x6;
			m_Owner = mobile;
			Name = "Mace And Shield Reading Glasses";
			Weight = 1;
		...
		public MaceAndShieldGlassesFaction( Serial serial ) : base( serial )
		{
		}
