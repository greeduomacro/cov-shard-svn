...
{
	public class SpiritOfTheTotemFaction : BearMask
	{
		...
		[Constructable]
		public SpiritOfTheTotemFaction( Faction faction, Mobile mobile ) : base()
		{
			Hue = 0x455;
		...
		public SpiritOfTheTotemFaction( Serial serial ) : base( serial )
		{
		}
