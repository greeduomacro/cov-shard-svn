...
namespace Server.Items
{
	public class SlayerGroup
	{
		...
		static SlayerGroup()
		{
			...
			humanoid.Super = new SlayerEntry( SlayerName.Repond, typeof( Rakktavi ), typeof( TiktaviR ), typeof( VitaviR ), typeof( ArcticOgreLord ), typeof( Cyclops ), typeof( Ettin ), typeof( EvilMage ), typeof( EvilMageLord ), typeof( FrostTroll ), typeof( MeerCaptain ), typeof( MeerEternal ), typeof( MeerMage ), typeof( MeerWarrior ), typeof( Ogre ), typeof( OgreLord ), typeof( Orc ), typeof( OrcBomber ), typeof( OrcBrute ), typeof( OrcCaptain ), typeof( OrcScout ), typeof( OrcishLord ), typeof( OrcishMage ), typeof( Ratman ), typeof( RatmanArcher ), typeof( RatmanMage ), typeof( SavageRider ), typeof( SavageShaman ), typeof( Savage ), typeof( Titan ), typeof( Troll ), /* Mondain's Legacy */ typeof( Troglodyte ), typeof( MougGuur ), typeof( Chiikkaha ), typeof( Minotaur ) /* ML End, SA begins */, typeof( Medusa ) );
			...
			elemental.Entries = new SlayerEntry[]

				{
					...
					new SlayerEntry( SlayerName.ElementalHealth, typeof( AcidElementalR ), typeof( FireElementalR ), typeof( PoisonElemental ) ),
					new SlayerEntry( SlayerName.FlameDousing, typeof( FireElemental ), typeof( FireElementalR ), typeof( SummonedFireElemental ) ),
			...
			if( Core.AOS )
			{
				abyss.Super = new SlayerEntry( SlayerName.Exorcism, typeof( DevourerR ), typeof( FireDaemon1 ), typeof( AbysmalHorror ), typeof( AbyssalInfernal ), typeof( ArcaneDaemon ), typeof( Balron ), typeof( BoneDemon ), typeof( ChaosDaemon ), typeof( Daemon ), typeof( SummonedDaemon ), typeof( DemonKnight ), typeof( Devourer ), typeof( EnslavedGargoyle ), typeof( FanDancer ), typeof( FireGargoyle ), typeof( Gargoyle ), typeof( GargoyleDestroyer ), typeof( GargoyleEnforcer ), typeof( Gibberling ), typeof( HordeMinion ), typeof( IceFiend ), typeof( Imp ), typeof( Impaler ), typeof( Moloch ), typeof( Oni ), typeof( Ravager ), typeof( Semidar ), typeof( StoneGargoyle ), typeof( Succubus ), typeof( TsukiWolf ), /* Mondain's Legacy */ typeof( Szavetra ), typeof( CrystalDaemon ) /* End */ );
			...
			{
				abyss.Super = new SlayerEntry( SlayerName.Exorcism, typeof( DevourerR ), typeof( FireDaemon1 ), typeof( SlasherOfVeils ), typeof( AbyssalInfernal ), typeof( AbysmalHorror ), typeof( Balron ), typeof( BoneDemon ), typeof( ChaosDaemon ), typeof( Daemon ), typeof( SummonedDaemon ), typeof( DemonKnight ), typeof( Devourer ), typeof( Gargoyle ), typeof( FireGargoyle ), typeof( Gibberling ), typeof( HordeMinion ), typeof( IceFiend ), typeof( Imp ), typeof( Impaler ), typeof( Ravager ), typeof( StoneGargoyle ), typeof( ArcaneDaemon ), typeof( EnslavedGargoyle ), typeof( GargoyleDestroyer ), typeof( GargoyleEnforcer ), typeof( Moloch ), typeof( Vasanord ), typeof( Korpre ), typeof( PutridUndeadGuardian ), typeof( GargoyleShade ), typeof( Szavetra ), typeof( Putrefier ) );
