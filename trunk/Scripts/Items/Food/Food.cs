...
namespace Server.Items
{
	public abstract class Food : Item, IEngravable
	{
		...
		public bool FillHunger( Mobile from, int fillFactor, int hitsbonus, int manabonus )  // added: int hitsbonus, int manabonus - alari
		{
			if ( from.Hunger >= 20 )
			{
    ...
    public class RawRotWormMeat : Food
    {
        public override int LabelNumber { get { return 1031705; } }//Raw Rotworm Meat
        public override double DefaultWeight
        {
            get { return 0.1; }
        }
