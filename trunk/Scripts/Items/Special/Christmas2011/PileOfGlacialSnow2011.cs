...
{
	public class PileOfGlacialSnow2011 : Item
	{
		[Constructable]
		public PileOfGlacialSnow2011() : base( 0x913 )
		{
			Hue = 0x480;
			Weight = 1.0;
		...
		public PileOfGlacialSnow2011( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.CanBeginAction( typeof( SnowPile2011 ) ) )
			{
		...
		private class InternalTimer : Timer
		{
			...
			{
				m_From.EndAction( typeof( SnowPile2011 ) );
			}
		}
		...
		private class SnowTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object target )
			{
				...
				else if ( target is Mobile )
				{
					...
					if ( pack != null && pack.FindItemByType( new Type[]{ typeof( SnowPile2011 ), typeof( PileOfGlacialSnow2011 ) } ) != null )
					{
						if ( from.BeginAction( typeof( SnowPile2011 ) ) )
						{
