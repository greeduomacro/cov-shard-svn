...
namespace Server.Items
{
	...
	{
		[Constructable]
		public PileOfGlacialSnow2008() : base( 0x913 )
		{
			Hue = 0x480;
			Weight = 1.0;
		...
		public PileOfGlacialSnow2008( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnSingleClick( Mobile from )
		{
			...
			LabelTo( from, "Christmas 2009" ); // Winter 2009
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( "Christmas 2009"  ); // Winter 2009
		}
