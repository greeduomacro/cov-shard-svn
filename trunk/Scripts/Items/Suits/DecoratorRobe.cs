...
{
	public class DecoratorRobe : BaseSuit
	{
		[Constructable]
		public DecoratorRobe() : base( AccessLevel.GameMaster, 0x38, 0x204F )
		{
			Name = "Decorator Robe";
		}
		...
		public DecoratorRobe( Serial serial ) : base( serial )
		{
		}
