...
{
	public class WorldBuilderRobe : BaseSuit
	{
		[Constructable]
		public WorldBuilderRobe() : base( AccessLevel.GameMaster, 0x204F, 0x204F )
		{
			Name = "WorldBuilder Robe";
		}
		...
		public WorldBuilderRobe( Serial serial ) : base( serial )
		{
		}
