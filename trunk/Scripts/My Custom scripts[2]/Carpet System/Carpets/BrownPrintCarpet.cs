...
namespace Server.Items
{
	...
	public class BrownPrintCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new BrownPrintCarpetDeed(); } }
		...
		[Constructable]
		public BrownPrintCarpetAddon( Rectangle2D rect )
		{
			...
			Hue = 2425; // Set Hue of Rug Here
				
		}

		public BrownPrintCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BrownPrintCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public BrownPrintCarpetDeed( )
		{
			Name =  "Brown Print Carpet";
		}

		public BrownPrintCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			BrownPrintCarpetDeed m_Deed = state as BrownPrintCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new BrownPrintCarpetAddon( rect );
