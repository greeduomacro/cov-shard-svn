...
namespace Server.Items
{
	...
	public class BlueXweaveCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new BlueXweaveCarpetDeed(); } }
		...
		[Constructable]
		public BlueXweaveCarpetAddon( Rectangle2D rect )
		{
		...
		public BlueXweaveCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BlueXweaveCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public BlueXweaveCarpetDeed( )
		{
			Name =  "Blue Xweave Carpet";
		}

		public BlueXweaveCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			BlueXweaveCarpetDeed m_Deed = state as BlueXweaveCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new BlueXweaveCarpetAddon( rect );
