...
namespace Server.Items
{
	...
	public class RedBlueCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new RedBlueCarpetDeed(); } }
		...
		[Constructable]
		public RedBlueCarpetAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public RedBlueCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class RedBlueCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public RedBlueCarpetDeed( )
		{
			Name =  "Red/Blue Carpet";
		}

		public RedBlueCarpetDeed( Serial serial ) : base( serial )
		{
		}
