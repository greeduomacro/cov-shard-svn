...
namespace Server.Items
{
	...
	public class BrownRugAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new BrownRugDeed(); } }
		...
		[Constructable]
		public BrownRugAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public BrownRugAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class BrownRugDeed : BaseAddonDeed
	{
		...
		public BrownRugDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			BrownRugDeed m_Deed = state as BrownRugDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new BrownRugAddon( rect );
