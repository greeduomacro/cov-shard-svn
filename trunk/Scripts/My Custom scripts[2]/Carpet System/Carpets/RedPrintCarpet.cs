...
namespace Server.Items
{
	...
	public class RedPrintCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new RedPrintCarpetDeed(); } }
		...
		[Constructable]
		public RedPrintCarpetAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public RedPrintCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class RedPrintCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public RedPrintCarpetDeed( )
		{
			Name =  "Red Print Carpet";
		}

		public RedPrintCarpetDeed( Serial serial ) : base( serial )
		{
		}
