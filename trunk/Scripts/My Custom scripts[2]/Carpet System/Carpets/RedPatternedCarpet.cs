...
namespace Server.Items
{
	...
	public class RedPatternedCarpetAddon : BaseAddon
	{
		public override BaseAddonDeed Deed{ get{ return new RedPatternedCarpetDeed(); } }
		...
		[Constructable]
		public RedPatternedCarpetAddon( Rectangle2D rect )
		{
...
//			Hue = 1419; // Set Hue of Rug Here
		...
		public RedPatternedCarpetAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class RedPatternedCarpetDeed : BaseAddonDeed
	{
		public override BaseAddon Addon{ get{ return null; } }
		

		[Constructable]
		public RedPatternedCarpetDeed( )
		{
			Name =  "Red Patterned Carpet";
		}

		public RedPatternedCarpetDeed( Serial serial ) : base( serial )
		{
		}
		...
		{
			RedPatternedCarpetDeed m_Deed = state as RedPatternedCarpetDeed;
			...
			if ( m_Deed.IsChildOf( from.Backpack ) )
			{
				...
				BaseAddon addon = new RedPatternedCarpetAddon( rect );
