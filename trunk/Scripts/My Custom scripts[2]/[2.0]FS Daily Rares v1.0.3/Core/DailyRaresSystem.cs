	...
	public class DailyRaresSystem
	{
		...
		public static void SpawnExtras()
		{
			...
			if ( EnableTrammel == true )
			{
				...
				//fdrs6.ReSpawn( 1, TimeSpan.FromMinutes( 5 ), TimeSpan.FromMinutes( 10 ), 0, 4, art );
			}
