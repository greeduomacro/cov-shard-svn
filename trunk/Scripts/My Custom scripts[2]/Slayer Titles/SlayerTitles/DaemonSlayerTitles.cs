...
{
    public class DaemonSlayerTitles : BaseSlayerTitle
    {
        ...
        public static void Initialize()
        {
             ...
             */
            KilledByEvent += new KilledByEventHandler(DaemonSlayerTitles_KilledByEvent);
        }
        ...
        public override string SlayerTitleName { get { return "Daemon Slayer"; } }


        // Use the contructor section to define the number of kills needed for each level of title progression
        public DaemonSlayerTitles()
        {
            AddSlayerTitleEntry(new SlayerTitleEntry(50, "Hunter of the Dark"));
            AddSlayerTitleEntry(new SlayerTitleEntry(100, "Master of the Unholy Ones"));
            AddSlayerTitleEntry(new SlayerTitleEntry(250, "Legendary Hunter of the Unholy"));
        }
    }
    /*
