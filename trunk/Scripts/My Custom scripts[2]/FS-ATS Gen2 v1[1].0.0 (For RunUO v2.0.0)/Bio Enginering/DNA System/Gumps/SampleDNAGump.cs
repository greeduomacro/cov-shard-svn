	...
	public class SampleDNAGump : Gump
	{
  	...
  	public class ProwessTarget : Target 
		...
		private EmptyDNAVial m_Vial;
			...
			{
				from.SendMessage( "You cannot extract DNA from that creature." );
			}
            ...
            {
                from.SendMessage("You cannot extract DNA from that creature, Tannis say's NO!");
			}
			else if ( target is BaseCreature )
			{
                ...
                else if (bc.BodyValue == 198 || bc.BodyValue == 197 || bc.BodyValue == 243 || bc.BodyValue == 277 )
				{
                    from.SendMessage("You cannot extract DNA from that creature, Tannis say's NO!");
				}
