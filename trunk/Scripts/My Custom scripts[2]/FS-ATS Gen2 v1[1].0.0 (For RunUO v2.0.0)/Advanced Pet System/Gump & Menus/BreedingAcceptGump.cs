...
namespace Server.Gumps
{
	public class BreedingAcceptGump : Gump
	{
		...
		public BreedingAcceptGump( Mobile pet1, Mobile pet2 ) : base( 0, 0 )
		{
			...
			AddHtml( 49, 122, 271, 161, @"<CENTER><U>Breeding Request</U><BR><BR>Someone has requested to breed their pet with one of yours. If you decide to accept this offer, both you and the other pet owner will get a baby from this union.<BR><BR>If you accept, and breeding is successful, both pets (Mother/Father) will be stabled in the animal breeders stable until the birth of the babies. This takes three days. After that both pets will not be able to breed again for six days. The animal breeder will give you a claim ticket. When the three days are up, you can then return to the animal breeder and drop your ticket on them, They will charge a five thousand gold coin fee for their services. Then you will get back your pet and the baby.<BR><BR>Do you accept?", (bool)false, (bool)true);
