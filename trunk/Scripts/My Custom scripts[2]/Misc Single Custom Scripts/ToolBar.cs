...
namespace Server.Commands
{
	public class CustomCmdHandler4
	{
		...
		{
			Register( "GmToolBox", AccessLevel.GameMaster, new CommandEventHandler( Lhide_OnCommand ) );
		}
        ...
        { 
            ...
            { 
				...
				case 2:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Tele", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
				...
				case 5:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Go", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
				...
				case 6:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Res", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
				...
				case 7:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Kill", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
				...
				case 11:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Self Hide", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
				...
				case 12:
				{
					...
					if ( from.AccessLevel > AccessLevel.Counselor )
					{
					CommandSystem.Handle( from, String.Format( "{0}Self Unhide", prefix ) );	
					}
					else
					{
					from.SendMessage( "NOT" );
