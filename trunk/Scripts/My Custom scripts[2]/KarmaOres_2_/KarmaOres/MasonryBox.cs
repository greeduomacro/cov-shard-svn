...
namespace Server.Items
{
	public class MasonryBoxGump : Gump
	{
		...
		public MasonryBoxGump( PlayerMobile from, MasonryBox box ) : base( 25, 25 )
		{
            ...
            AddLabel(320, 135, 1163, @"Jade");
            AddLabel(425, 135, 0x480, box.Jade.ToString());
            AddButton(285, 135, 4005, 4007, 13, GumpButtonType.Reply, 0);
			
			AddLabel(320, 155, 1155, @"Moonstone");
			AddLabel( 425, 155, 0x480, box.Moonstone.ToString() );
			AddButton(285, 155, 4005, 4007, 14, GumpButtonType.Reply, 0);
			
			AddLabel(320, 175, 1359, @"Sunstone");
			AddLabel( 425, 175, 0x480, box.Sunstone.ToString() );
			AddButton(285, 175, 4005, 4007, 15, GumpButtonType.Reply, 0);
			
			AddLabel(320, 195, 990, @"Mallet and Chisel");
			AddLabel( 425, 195, 0x480, box.Masonry.ToString() );
