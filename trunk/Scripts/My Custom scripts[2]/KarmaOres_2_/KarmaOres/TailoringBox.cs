...
namespace Server.Items
{
	public class TailoringBoxGump : Gump
	{
		...
		public TailoringBoxGump( PlayerMobile from, TailoringBox box ) : base( 25, 25 )
		{
			...
			AddBackground( 12, 19, 486, 325, 9250);
            ...
            AddLabel( 60, 255, 990, @"Bones");
			AddLabel(  150, 255, 0x480, box.Bones.ToString() );
			...
			AddButton( 285, 115, 4005, 4007, 11, GumpButtonType.Reply, 0 );			
			
			AddLabel(320, 135, 2219, @"Spined Runic");
			AddLabel( 410, 135, 0x480, box.RunicSpined.ToString() );
			AddButton(285, 135, 4005, 4007, 12, GumpButtonType.Reply, 0);
			
			AddLabel(320, 155, 2116, @"Horned Runic");
			AddLabel( 410, 155, 0x480, box.RunicHorned.ToString() );
			AddButton(285, 155, 4005, 4007, 13, GumpButtonType.Reply, 0);
			
			AddLabel(320, 175, 2128, @"Barbed Runic");
			AddLabel( 410, 175, 0x480, box.RunicBarbed.ToString() );
			AddButton(285, 175, 4005, 4007, 14, GumpButtonType.Reply, 0);
			
			AddLabel(320, 195, 1159, @"Dragon Runic");
			AddLabel( 410, 195, 0x480, box.RunicDragon.ToString() );
			AddButton(285, 195, 4005, 4007, 15, GumpButtonType.Reply, 0);
			
			AddLabel(320, 215, 986, @"Daemon Runic");
			AddLabel( 410, 215, 0x480, box.RunicDaemon.ToString() );
			AddButton(285, 215, 4005, 4007, 16, GumpButtonType.Reply, 0);
			
			/*AddLabel(320, 235, 990, @"Bone Runic");
