...
namespace Server.Engines.Craft
{
	public class DefJuicing : CraftSystem
	{
		...
		private DefJuicing() : base( 1, 1, 1.25 )// base( 1, 1, 3.0 )
		{
		}
		...
		public override void InitCraftList()
		{
           ...
           /* //Special Drinks/Juices
            index = AddCraft(typeof(JuiceKeg), "Special Drinks/Juices", "Keg of Lemonade", 20.00, 120.0, typeof( Lemon ), "Lemons", 25 );
            AddRes(index, typeof(Lime), "Limes", 25);
            AddRes(index, typeof(BaseBeverage), "Water", 5);
            AddRes(index, typeof(Keg), "Keg", 1);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1);/////////////////////////*/
