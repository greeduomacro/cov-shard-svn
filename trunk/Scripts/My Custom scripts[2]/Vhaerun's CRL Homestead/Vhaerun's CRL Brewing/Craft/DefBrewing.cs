...
namespace Server.Engines.Craft
{
	public class DefBrewing : CraftSystem
	{
		...
		private DefBrewing() : base( 1, 1, 1.25 )// base( 1, 1, 3.0 )
		{
		}
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( MeadKeg ), "Mead", "Keg of Mead", 80.0, 105.6, typeof( BitterHops ), "Bitter Hops", 10 );
			...
			index = AddCraft( typeof( AleKeg ), "Ale", "Keg of Ale", 80.0, 105.6, typeof( BitterHops ), "Bitter Hops", 10 );
			AddRes( index, typeof( Keg ), "Keg", 1 );
			AddRes( index, typeof( BaseBeverage ), "Water", 20 );
			...
			index = AddCraft( typeof( CiderKeg ), "Cider", "Keg of Cider", 80.0, 105.6, typeof( Keg ), "Keg", 1 );
