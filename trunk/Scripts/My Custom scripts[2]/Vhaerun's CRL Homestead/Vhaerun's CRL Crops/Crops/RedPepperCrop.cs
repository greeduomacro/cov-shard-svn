...
{ 
	...
	{ 
		...
		[Constructable] 
		public RedPepperSeedling( Mobile sower ) : base( Utility.RandomList ( 0xCB6, 0xCB0 ) ) 
		{ 
			Movable = false; 
	...
	{ 
		...
		[Constructable] 
		public RedPepperCrop( Mobile sower ) : base( Utility.RandomList( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( RedPepperCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
