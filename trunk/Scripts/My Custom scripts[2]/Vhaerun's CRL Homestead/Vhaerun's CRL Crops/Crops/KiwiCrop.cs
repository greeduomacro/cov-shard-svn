...
{ 
	...
	{ 
		...
		[Constructable]
		public KiwiSeed() : this( 1 )
		{
		}

		[Constructable]
		public KiwiSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public KiwiSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public KiwiSeedling( Mobile sower ) : base( Utility.RandomList ( 0x1A99, 0x1A9A ) ) 
		{ 
			Movable = false; 
			Name = "Kiwi Seedling"; 
			m_sower = sower;
		...
		public KiwiSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public KiwiCrop( Mobile sower ) : base( Utility.RandomList( 0xD37, 0xD38 ) ) 
		{ 
			Movable = false; 
			Name = "Kiwi Plant";
			Hue = 0x49;
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( KiwiCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
		...
		public KiwiCrop( Serial serial ) : base( serial ) 
		{ 
		} 
