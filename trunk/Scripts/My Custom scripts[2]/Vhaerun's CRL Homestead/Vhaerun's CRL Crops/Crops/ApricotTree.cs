...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public ApricotTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public ApricotTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public ApricotTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public ApricotSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public ApricotSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class ApricotTree : BaseTree
	{
		...
		[Constructable] 
		public ApricotTree( Point3D pnt, Map map ) : base( Utility.RandomList( 0xDAA, 0xDA6 ) ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Apricot Tree";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( ApricotTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( ApricotTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public ApricotTree( Serial serial ) : base( serial )
		{
		}
