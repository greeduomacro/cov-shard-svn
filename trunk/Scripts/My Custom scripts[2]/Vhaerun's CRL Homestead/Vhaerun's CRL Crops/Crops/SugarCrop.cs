...
{ 
	...
	{ 
		...
		[Constructable]
		public SugarSeed() : this( 1 )
		{
		}

		[Constructable]
		public SugarSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public SugarSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public SugarSeedling( Mobile sower ) : base( Utility.RandomList ( 0x1EBE, 0x1EBF ) ) 
		{ 
			Movable = false; 
		...
		public SugarSeedling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public SugarCrop( Mobile sower ) : base( Utility.RandomList( 0xC58, 0xC59 ) ) 
		{ 
			Movable = false; 
			Name = "Sugarcane";
			Hue = 0x23F;
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( SugarCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
		...
		public SugarCrop( Serial serial ) : base( serial ) 
		{ 
		} 
