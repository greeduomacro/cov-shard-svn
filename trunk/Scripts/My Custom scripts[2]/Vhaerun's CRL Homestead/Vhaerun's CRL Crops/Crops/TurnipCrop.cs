...
{ 
	...
	{ 
		...
		[Constructable] 
		public TurnipSeedling( Mobile sower ) : base( 0xC61 )
		{ 
			Movable = false; 
	...
	{ 
		...
		[Constructable] 
		public TurnipCrop( Mobile sower ) : base( 0xC62 ) 
		{ 
			Movable = false; 
			Name = "Turnip"; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( TurnipCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
