...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public AlmondTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public AlmondTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public AlmondTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public AlmondSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public AlmondSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class AlmondTree : BaseTree
	{
		...
		[Constructable] 
		public AlmondTree( Point3D pnt, Map map ) : base( 0xCE5 ) // leaves
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Almond Tree";
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( AlmondTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( AlmondTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public AlmondTree( Serial serial ) : base( serial )
		{
		}
