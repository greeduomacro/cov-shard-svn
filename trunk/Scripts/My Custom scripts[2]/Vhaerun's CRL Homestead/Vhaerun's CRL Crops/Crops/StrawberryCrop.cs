...
{ 
	...
	{ 
		...
		[Constructable] 
		public StrawberryCrop( Mobile sower ) : base( Utility.RandomList( 0x1A99, 0x1A9A ) ) 
		{ 
			Movable = false; 
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( StrawberryCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
