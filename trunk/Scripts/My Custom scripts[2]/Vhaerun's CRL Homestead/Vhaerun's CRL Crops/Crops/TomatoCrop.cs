...
{ 
	...
	{ 
		...
		[Constructable] 
		public TomatoSeedling( Mobile sower ) : base( 0xC61 )
		{ 
			Movable = false; 
	...
	{ 
		...
		[Constructable] 
		public TomatoCrop( Mobile sower ) : base( 0xC9C ) 
		{ 
			Movable = false; 
			Name = "Tomato Plant";
			Hue = 0x10A;
		...
		private class CropTimer : Timer
		{
			...
			public CropTimer( TomatoCrop plant ) : base( TimeSpan.FromSeconds( 600 ), TimeSpan.FromSeconds( 15 ) )
			{
