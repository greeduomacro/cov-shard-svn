...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public AvocadoTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public AvocadoTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public AvocadoTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public AvocadoSapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public AvocadoSapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class AvocadoTree : BaseTree
	{
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( AvocadoTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( AvocadoTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public AvocadoTree( Serial serial ) : base( serial )
		{
		}
