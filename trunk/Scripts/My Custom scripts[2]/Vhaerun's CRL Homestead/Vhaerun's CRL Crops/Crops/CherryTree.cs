...
namespace Server.Items.Crops
{
	...
	{ 
		...
		[Constructable]
		public CherryTreeSeed() : this( 1 )
		{
		}

		[Constructable]
		public CherryTreeSeed( int amount ) : base( 0xF27 )
		{
			Stackable = true; 
			Weight = .5; 
			Hue = 0x5E2; 
		...
		public CherryTreeSeed( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	{ 
		...
		[Constructable] 
		public CherrySapling() : base( Utility.RandomList ( 0xCE9, 0xCEA ) ) 
		{ 
			Movable = false; 
		...
		public CherrySapling( Serial serial ) : base( serial ) 
		{ 
		} 
	...
	public class CherryTree : BaseTree
	{
		...
		[Constructable] 
		public CherryTree( Point3D pnt, Map map ) : base( Utility.RandomList ( 0x2475, 0x2474, 0x2473, 0x2472, 0x2471  ) ) 
		{
			Movable = false;
			MoveToWorld( pnt, map );
			Name = "Cherry Tree";
...
*/
		...
		private class FruitTimer : Timer
		{
			...
			public FruitTimer( CherryTree plant ) : base( TimeSpan.FromSeconds( 900 ), TimeSpan.FromSeconds( 30 ) )
			{
		...
		private class StumpTimer : Timer
		{
			...
			public StumpTimer( CherryTree Tree, FruitTreeStump Stump, Mobile from ) : base( TimeSpan.FromMilliseconds( 5500 ) )
			{
		...
		public CherryTree( Serial serial ) : base( serial )
		{
		}
