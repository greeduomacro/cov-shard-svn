...
// AddRes( index, typeof( Consume2 ), Consume2, qty, Error );
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft( typeof( FishSteak ), "Barbecue", "Fish Steak", 0.0, 100.0, typeof( RawFishSteak ), "Raw Fish Steaks", 1, 1044253 );
...
//	prkrib		AddRes( index, typeof( FoodPlate ), "Plate", 1, "You need a plate!" );
...
//	pig		index = AddCraft( typeof( RoastPig ), "Other Food", "Roast Pig", 0.0, 100.0, typeof( xxxxxx ), "xxxx", 1, 1044253 );
			...
			AddRes( index, typeof( GroundPork ), "Ground Pork", 2, 1044253 );
