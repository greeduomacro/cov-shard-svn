...
namespace Server.Engines.Craft
{
	public class DefBoiling : CraftSystem
	{
		...
		private DefBoiling() : base( 1, 1, 1.25 )// base( 1, 1, 1.5 )
		{
		}
...
// AddRes( index, typeof( Consume2 ), Consume2, qty, Error );
		...
		public override void InitCraftList()
		{
            ...
            index = AddCraft(typeof(StrawberryJam), "Other", "Strawberry Jam", 0.0, 100.0, typeof(Strawberry), "Strawberries", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(AppleJam), "Other", "Apple Jam", 0.0, 100.0, typeof(Apple), "Apples", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(PeachJam), "Other", "Peach Jam", 0.0, 100.0, typeof(Peach), "Peach's", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(GrapeJam), "Other", "Grape Jam", 0.0, 100.0, typeof(Grapes), "Grapes", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(BlackberryJam), "Other", "Blackberry Jam", 0.0, 100.0, typeof(Blackberries), "Blackberries", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);

            index = AddCraft(typeof(OrangeMarmelade), "Other", "Orange Marmelade", 0.0, 100.0, typeof(Orange), "Oranges", 20, 1044253);
            AddRes(index, typeof(BagOfSugar), "Bag of Sugar", 1, 1044253);
            SetNeedOven(index, true);
