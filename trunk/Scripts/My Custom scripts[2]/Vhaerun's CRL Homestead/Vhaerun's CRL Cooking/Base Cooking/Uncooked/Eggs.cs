...
*/
	public class Eggs : Item
	{
		...
		public Food CookedFood{ get{ return new FriedEggs(); } }
	//	public Food BurnedFood{ get{ return new BurnedFriedEggs(); } }
		...
		//		private Food m_BurnedFood;
				...
				public InternalTimer( Mobile from, IPoint3D p, Map map, int min, int max, Food cookedFood/*, Food burnedFood*/ ) : base( TimeSpan.FromSeconds( 1.0 ) )
				{
					m_From = from;
					m_Point = p;
					m_Map = map;
