...
namespace Server.Items
{
	public class CakeMix : Item
	{
		...
		public Food CookedFood{ get{ return new Cake( this.Hue ); } }
	//	public Food BurnedFood{ get{ return new BurnedCake(); } }
		...
		[Constructable]
		public CakeMix() : this( "", 0 )
		{
		}

		[Constructable]
		public CakeMix( string desc ) : this( desc, 0 )
		{
		}

		[Constructable]
		public CakeMix( int Color ) : this( "", Color )
		{
		}

		[Constructable]
		public CakeMix( string desc, int Color ) : base( 0x103F )
		{
			Weight = 1.0;
			if ( Color != 0 )
				Hue = Color;
		...
		public class InternalTarget : Target
		{
			...
			public InternalTarget( CakeMix item ) : base( 1, false, TargetFlags.None )
			{
				m_Item = item;
			}
